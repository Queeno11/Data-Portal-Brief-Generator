...
gr2 <- paste0("Briefs/Graphs_legend_top/p1_", x[which(x$wbcountryname == params$countrynamet),"wbcode"],"_all.pdf")
...
gr3 <- paste0("Briefs/Graphs_legend_top/p2_", x[which(x$wbcountryname == params$countrynamet),"wbcode"], "_stages.pdf")
