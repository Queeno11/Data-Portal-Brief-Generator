...
\vspace{-5mm}
\small Note: Missing symbols indicate the internationally comparable data are not available to generate the corresponding indicator.
...
**The Human Capital Complementary Indicators (HCCIs) offer a snapshot of human capital investments at four stages of the lifecycle.** The figures show the latest available data, benchmarked against regional averages. The figures also report progress over the last 5 years.
