...
* **Placeholder text.** `r x[which(x$wbcountryname == params$countrynamet),"psurv_text"]`

\vspace{-1mm}
\begin{table}[H]
\renewcommand{\tabcolsep}{0.8mm}
\begin{tabular}{m{0.305\textwidth}>{\centering\arraybackslash}m{0.053\textwidth}>{\centering\arraybackslash}m{0.053\textwidth}>{\centering\arraybackslash}m{0.053\textwidth}}
\\\textbf{     }   &    &             &  \\ \hline
                         &      &              & \\
