...
\vspace{-1mm} \\
Human Capital Index (HCI) &   `r x[which(x$wbcountryname == params$countrynamet),"hci_m_t"]` &   `r x[which(x$wbcountryname == params$countrynamet),"hci_f_t"]` &    `r x[which(x$wbcountryname == params$countrynamet),"hci_t"]` \\
...
```{r gr2, out.height= "82%", fig.align = "right", echo=FALSE}
