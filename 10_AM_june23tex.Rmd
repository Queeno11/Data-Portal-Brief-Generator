...
\vspace{-1mm} \\
HCI & & & & & & & & & & & & & &   `r x[which(x$wbcountryname == params$countrynamet),"hci_m_t"]` &   `r x[which(x$wbcountryname == params$countrynamet),"hci_f_t"]` &    `r x[which(x$wbcountryname == params$countrynamet),"hci_t"]`\\
Survival to Age 5 & & & & & & & & & & & & & & `r x[which(x$wbcountryname == params$countrynamet),"psurv_m_t"]`  &  `r x[which(x$wbcountryname == params$countrynamet),"psurv_f_t"]` & `r x[which(x$wbcountryname == params$countrynamet),"psurv_t"]` \\
Expected Years of School & & & & & & & & & & & & & &  `r x[which(x$wbcountryname == params$countrynamet),"eyrs_m_t"]`   &  `r x[which(x$wbcountryname == params$countrynamet),"eyrs_f_t"]`  &  `r x[which(x$wbcountryname == params$countrynamet),"eyrs_t"]` \\
Harmonized Test Scores & & & & & & & & & & & & & &  `r x[which(x$wbcountryname == params$countrynamet),"test_m_t"]` &  `r x[which(x$wbcountryname == params$countrynamet),"test_f_t"]` & `r x[which(x$wbcountryname == params$countrynamet),"test_t"]` \\
Learning-adjusted Years of School & & & & & & & & & & & & & &  `r x[which(x$wbcountryname == params$countrynamet),"qeyrs_m_t"]`  &  `r x[which(x$wbcountryname == params$countrynamet),"qeyrs_f_t"]`  &  `r x[which(x$wbcountryname == params$countrynamet),"qeyrs_t"]`\\
Adult Survival Rate & & & & & & & & & & & & & & `r x[which(x$wbcountryname == params$countrynamet),"asr_m_t"]`  &  `r x[which(x$wbcountryname == params$countrynamet),"asr_f_t"]`  &  `r x[which(x$wbcountryname == params$countrynamet),"asr_t"]`\\
Not Stunted Rate & & & & & & & & & & & & & & `r x[which(x$wbcountryname == params$countrynamet),"nostu_m_t"]`  & `r x[which(x$wbcountryname == params$countrynamet),"nostu_f_t"]`  &  `r x[which(x$wbcountryname == params$countrynamet),"nostu_t"]`\\
