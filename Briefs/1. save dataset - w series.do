...
*------------------------------------------------------------------------------*
	...
	*---------------------------------Reshape----------------------------------*
		...
		reshape wide $pre, i(wbcode wbcountryname wbregion wbincome year prevyear) j(gend) string
		rename *_t *
	...
	*---------------------------------keep if----------------------------------*
		save "$dhci\data_briefs_allcountries_wprev", replace
		
	*--------------------------------save data---------------------------------*
		keep if hci!=.
		
		save "$dhci\data_briefs_wprev", replace