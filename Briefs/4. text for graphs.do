...
*------------------------------------------------------------------------------*
	...
	*--------------------------------Directories-------------------------------*
		...
		*gl root "C:\Users\marco\Documents\HCI"
		*global input "${root}\Data\In use\DTA"
		global root "C:\Users\Jessie\Documents\Meli\Banco Mundial\HC and Climate Change\HCI update\"
		global input "${root}/Data"
		global charts "${root}/Outputs"
		global dfiles "${root}/Scripts"
		local outputfilepath "${root}/Outputs"
		cd "${root}"
	...
	*--------------------------------Load data---------------------------------*
		...
		*tab wbcountryname if inlist(wbcode,"COG","COD","EGY","IRN","KOR")
/*		
		replace wbcountryname = "Congo, Dem. rep" if wbcode=="COD"
		replace wbcountryname = "Congo,	Rep" if wbcode=="COG"
		replace wbcountryname = "Egypt, Arab Rep" if wbcode=="EGY"
		replace wbcountryname = "Iran, Islamic	Rep" if wbcode=="IRN"
		replace wbcountryname = "Korea,	Rep" if wbcode=="KOR"
*/
/*
...
/*
	rename y_* *_yr
	rename *_yr *_y
	rename fao_water_stress_y fao_water_stress_all_y
*/	
/*	
	replace fao_water_stress_all=. if fao_water_stress_all>100
	replace fao_water_stress_all=. if fao_water_stress_all>100
*/		
/*		
	gen vac_covid_m2 = "January" if vac_covid_m==1
	replace vac_covid_m2 = "February" if vac_covid_m==2
	replace vac_covid_m2 = "March" if vac_covid_m==3
	replace vac_covid_m2 = "April" if vac_covid_m==4
	replace vac_covid_m2 = "May" if vac_covid_m==5
	replace vac_covid_m2 = "June" if vac_covid_m==6
	replace vac_covid_m2 = "July" if vac_covid_m==7
	replace vac_covid_m2 = "August" if vac_covid_m==8
	replace vac_covid_m2 = "September" if vac_covid_m==9
	replace vac_covid_m2 = "October" if vac_covid_m==10
	replace vac_covid_m2 = "November" if vac_covid_m==11
	replace vac_covid_m2 = "December" if vac_covid_m==12
	
	replace unicef_water_y = basicdwater_y if unicef_water==.
	replace unicef_water = basicdwater if unicef_water==.
*/	
	*-------------------------------Averages-------------------------------*
	
	/**** Agregar las vars nuevas ****/
	
		global preselect basicdwater basichandwashing basicsanitation eap_2wap_f_a eap_2wap_m_a eip_neet_f_y eip_neet_m_y eip_neet_mf_y emp_nifl_f_a emp_nifl_f_y emp_nifl_m_a emp_nifl_m_y emp_nifl_mf_a emp_nifl_mf_y fao_food_prices fao_prev_fsec_adf fao_prev_fsec_adm fao_prev_fsec_all improvedwater lastnm_afr lastnm_birth_reg lastnm_mmrt lastnm_probdeath_ncd lastnm_sec_ger lastnm_ter_ger limitedsanitation limitedwater managedwater per_sa_allsa_cov_pop_tot safelymanaged se_lpv_prim se_lpv_prim_fe se_lpv_prim_ma sp_dyn_le00_fe_in sp_dyn_le00_in sp_dyn_le00_ma_in uiscr1 uiscr1f uiscr1m uiscr2 uisger0 uisger0f uisger0m uisger01 uisger01f uisger01m uisger02 uisger02f uisger02m une_2eap_f_a une_2eap_f_y une_2eap_m_a une_2eap_m_y une_2eap_mf_a une_2eap_mf_y unicef_breastf unicef_care unicef_diarrhoea unicef_mealfreq unicef_neomort unicef_sanitation unicef_water vac_covid vacbcg vacdtp1 vacdtp3 vachepb3 vachepbb vachib3 vacipv1 vacmcv1 vacmcv2 vacpcv3 vacpol3 vacrcv1 vacrotac vacyfv hci_mf_2020 psurv_mf_2020 eyrs_mf_2020 test_mf_2020 qeyrs_mf_2020 asr_mf_2020 nostu_mf_2020
		
		foreach var in $preselect {
		bysort wbincomegroup: egen `var'_inc = mean(`var')
		bysort wbregion: egen `var'_reg = mean(`var')
		}
		
		*merge 1:1 wbcode using "$input\complete", nogen keep(3)
	
	*------------------------------Keep vars-----------------------------------*
	
	keep wb* unicef_neomort* unicef_mealfreq* vacbcg* uisger02* lastnm_mmrt* unicef_care* lastnm_birth_reg* unicef_breastf* unicef_diarrhoea* uiscr1* lastnm_sec_ger* vachepbb* se_lpv_prim* uiscr2* eip_neet_mf_y* lastnm_afr* lastnm_ter_ger* une_2eap_mf_y* emp_nifl_mf_y* eap_2wap_f_a* eap_2wap_m_a* sp_dyn_le00_in* lastnm_probdeath_ncd* une_2eap_mf_a* emp_nifl_mf_a* fao_prev_fsec_all* per_sa_allsa_cov_pop_tot* fao_water_stress_all* fao_food_prices* fao_prev_fsec_adf* unicef_sanitation* fao_prev_fsec_adm * unicef_water*
	...
	*--------------------------------HCI index---------------------------------*
	...
	gen hci_text_1 = ///
	"A child born in " + wbcountrynameb + " just before the pandemic will be **" + strofreal(round(hci_mf_2020,1)) + " percent**" ///
	+ " as productive when she grows up as she could be if she enjoyed complete education and full health." if hci_mf_2020!=.

	gen hci_text_2 = ///
	cond(hci_mf_2020>hci_mf_2020_reg & hci_mf_2020_reg<hci_mf_lower_2020 & hci_mf_2020>hci_mf_2020_inc & hci_mf_2020_inc<hci_mf_lower_2020, ///                 
	"This is higher than the average for the " + wbregion + " region (" + strofreal(round(hci_mf_2020_reg,1)) + " percent) and " + incomegroup + " (" + strofreal(round(hci_mf_2020_inc,1)) + " percent).", /// 
	cond(hci_mf_2020>hci_mf_2020_reg & hci_mf_lower_2020> hci_mf_2020_reg & hci_mf_2020>hci_mf_2020_inc & hci_mf_lower_2020<hci_mf_2020_inc, ///                        
	"This is higher than the average for the " + wbregion + " region (" + strofreal(round(hci_mf_2020_reg,1)) + " percent) and slightly higher than " + incomegroup +" (" + strofreal(round(hci_mf_2020_inc,1)) + " percent).", ///    
	cond(hci_mf_2020>hci_mf_2020_reg & hci_mf_2020_reg<hci_mf_lower_2020 & hci_mf_2020<hci_mf_2020_inc & hci_mf_2020_inc<hci_mf_upper_2020, ///                        
	"This is higher than the average for the " + wbregion + " region (" + strofreal(round(hci_mf_2020_reg,1)) + " percent) but slightly lower than the average for " + incomegroup +" (" + strofreal(round(hci_mf_2020_inc,1)) + " percent).", ///
	cond(hci_mf_2020>hci_mf_2020_reg & hci_mf_2020_reg<hci_mf_lower_2020 & hci_mf_2020<hci_mf_2020_inc & hci_mf_2020_inc>hci_mf_upper_2020, ///                        
	"This is higher than the average for the " + wbregion + " region (" + strofreal(round(hci_mf_2020_reg,1)) + " percent) but lower than the average for " + incomegroup +" (" + strofreal(round(hci_mf_2020_inc,1)) + " percent).", ///
	cond(hci_mf_2020>hci_mf_2020_reg & hci_mf_lower_2020<hci_mf_2020_reg & hci_mf_2020>hci_mf_2020_inc & hci_mf_lower_2020>hci_mf_2020_inc, ///                      
	"This is slightly higher than the average for the " + wbregion + " region (" + strofreal(round(hci_mf_2020_reg,1)) + " percent) and higher than the average for " + incomegroup + " (" + strofreal(round(hci_mf_2020_inc,1)) + " percent).", ///
	cond(hci_mf_2020>hci_mf_2020_reg & hci_mf_2020_reg>hci_mf_lower_2020 & hci_mf_2020>hci_mf_2020_inc & hci_mf_2020_inc>hci_mf_lower_2020, ///                       
	"This is slightly higher than the average for the " + wbregion + " region (" + strofreal(round(hci_mf_2020_reg,1)) + " percent) and " + incomegroup +" (" + strofreal(round(hci_mf_2020_inc,1)) + " percent).", ///    
	cond(hci_mf_2020>hci_mf_2020_reg & hci_mf_2020_reg>hci_mf_lower_2020 & hci_mf_2020<hci_mf_2020_inc & hci_mf_2020_inc<hci_mf_upper_2020, ///                       
	"This is slightly higher than the average for the " + wbregion + " region (" + strofreal(round(hci_mf_2020_reg,1)) + " percent) but slightly lower than the average for " + incomegroup +" (" + strofreal(round(hci_mf_2020_inc,1)) + " percent).", /// 
	cond(hci_mf_2020>hci_mf_2020_reg & hci_mf_2020_reg>hci_mf_lower_2020 & hci_mf_2020<hci_mf_2020_inc & hci_mf_2020_inc>hci_mf_upper_2020, ///                       
	"This is slightly higher than the average for the " + wbregion + " region (" + strofreal(round(hci_mf_2020_reg,1)) + " percent) but lower than the average for " + incomegroup +" (" + strofreal(round(hci_mf_2020_inc,1)) + " percent).", /// 
	cond(hci_mf_2020<hci_mf_2020_reg & hci_mf_2020_reg<hci_mf_upper_2020 & hci_mf_2020>hci_mf_2020_inc & hci_mf_2020_inc<hci_mf_lower_2020, ///                     
	"This is slightly lower than the average for the " + wbregion + " region (" + strofreal(round(hci_mf_2020_reg,1)) + " percent) but higher than the average for " + incomegroup +" (" + strofreal(round(hci_mf_2020_inc,1)) + " percent).", ///  
	cond(hci_mf_2020<hci_mf_2020_reg & hci_mf_2020_reg<hci_mf_upper_2020 & hci_mf_2020>hci_mf_2020_inc & hci_mf_2020_inc>hci_mf_lower_2020, ///                          
	"This is slightly lower than the average for the " + wbregion + " region (" + strofreal(round(hci_mf_2020_reg,1)) + " percent) but slightly higher than the average for " + incomegroup +" (" + strofreal(round(hci_mf_2020_inc,1)) + " percent).", ///
	cond(hci_mf_2020<hci_mf_2020_reg & hci_mf_2020_reg<hci_mf_upper_2020 & hci_mf_2020<hci_mf_2020_inc & hci_mf_2020_inc<hci_mf_upper_2020, ///                         
	"This is slightly lower than the average for the " + wbregion + " region (" + strofreal(round(hci_mf_2020_reg,1)) + " percent) and " + incomegroup +" (" + strofreal(round(hci_mf_2020_inc,1)) + " percent).", ///     
	cond(hci_mf_2020<hci_mf_2020_reg & hci_mf_upper_2020> hci_mf_2020_reg & hci_mf_2020<hci_mf_2020_inc & hci_mf_upper_2020<hci_mf_2020_inc, ///                         
	"This is slightly lower than the average for the " + wbregion + " region (" + strofreal(round(hci_mf_2020_reg,1)) + " percent) and lower than the average for " + incomegroup +" (" + strofreal(round(hci_mf_2020_inc,1)) + " percent).", ///   
	cond(hci_mf_2020<hci_mf_2020_reg & hci_mf_2020_reg>hci_mf_upper_2020 & hci_mf_2020>hci_mf_2020_inc & hci_mf_2020_inc<hci_mf_lower_2020, ///                         
	"This is lower than the average for the " + wbregion + " region (" + strofreal(round(hci_mf_2020_reg,1)) + " percent) but higher than the average for " + incomegroup +" (" + strofreal(round(hci_mf_2020_inc,1)) + " percent).", /// 
	cond(hci_mf_2020<hci_mf_2020_reg & hci_mf_2020_reg>hci_mf_upper_2020 & hci_mf_2020>hci_mf_2020_inc & hci_mf_2020_inc>hci_mf_lower_2020, ///                         
	"This is lower than the average for the " + wbregion + " region (" + strofreal(round(hci_mf_2020_reg,1)) + " percent) but slightly higher than the average for " + incomegroup +" (" + strofreal(round(hci_mf_2020_inc,1)) + " percent).", /// 
	cond(hci_mf_2020<hci_mf_2020_reg & hci_mf_upper_2020< hci_mf_2020_reg & hci_mf_2020<hci_mf_2020_inc & hci_mf_upper_2020>hci_mf_2020_inc, ///                         
	"This is lower than the average for the " + wbregion + " region (" + strofreal(round(hci_mf_2020_reg,1)) + " percent) but slightly lower than the average for " + incomegroup +" (" + strofreal(round(hci_mf_2020_inc,1)) + " percent).", /// 
	cond(hci_mf_2020<hci_mf_2020_reg & hci_mf_2020_reg>hci_mf_upper_2020 & hci_mf_2020<hci_mf_2020_inc & hci_mf_2020_inc>hci_mf_upper_2020, ///                         
	"This is lower than the average for the " + wbregion + " region (" + strofreal(round(hci_mf_2020_reg,1)) + " percent) and " + incomegroup +" (" + strofreal(round(hci_mf_2020_inc,1)) + " percent).", /// 
	"")))))))))))))))) if hci_mf_2020!=.
	
	gen hci_text_3= ///
	cond(dhci_2010 > 0, ///
	"Between 2010 and 2020, the HCI value for " + wbcountrynameb + " increased" ///
	+ " from " + strofreal(hci_mf_2010,"%4.2f") + " to " + strofreal(hci_mf_2020,"%4.2f") + ". Figure 1 shows how the HCI and each of the components evolved over time.", ///
	cond(dhci_2010 < 0, ///
	"Between 2010 and 2020, the HCI value for " + wbcountrynameb + " decreased" ///
	+ " from " + strofreal(hci_mf_2010,"%4.2f") + " to " + strofreal(hci_mf_2020,"%4.2f") + ". Figure 1 shows how the HCI and each of the components evolved over time.", ///
	"Between 2010 and 2020, the HCI value for " + wbcountrynameb + " remained approximately the same at " + strofreal(hci_mf_2020,"%4.2f") + ". Figure 1 shows how the HCI and each of the components evolved over time." )) if dhci_2010<.
	replace hci_text_3="" if hci_mf_2010==.
	
	gen hci_mf_2020_text = hci_text_1 + " " + hci_text_2 + " "  + hci_text_3
	replace hci_mf_2020_text = "The data on HCI is not available in " + wbcountrynameb + "." if hci_mf_2020==.
	*-------------------------------Components---------------------------------*
	
	gen psurv_mf_2020_text = ///
"**" + strofreal(round(psurv_mf_2020,1)) + "** out of 100 children born in " + wbcountrynameb + " survive to age 5." if psurv_mf_2020!=.
	replace psurv_mf_2020_text = "Internationally comparable data on probability of survival to age 5 are not available for " + wbcountrynameb + "." if psurv_mf_2020==.
	
	gen eyrs_mf_2020_text = ///
	"In " + wbcountrynameb + ", a child who starts school at age 4 can expect to complete **" + strofreal(round(eyrs_mf_2020,0.1)) + " years**"  ///
	+ " of school by her 18th birthday." if eyrs_mf_2020!=.
	replace eyrs_mf_2020_text = "Internationally comparable data on expected years of schooling are not available for " + wbcountrynameb + "." if eyrs_mf_2020==.
	
	gen test_mf_2020_text = ///
	"Students in " + wbcountrynameb + " score **" + strofreal(round(test_mf_2020,1))+ "**" ///
	+ " on a scale where 625 represents advanced attainment and 300 represents minimum attainment." if test_mf_2020!=.
	replace test_mf_2020_text = "Internationally comparable data on test scores are not available for " + wbcountrynameb + "." if test_mf_2020==.

	gen qeyrs_mf_2020_text = ///
	"Factoring in what children actually learn, expected years of school is only **" + strofreal(round(qeyrs_mf_2020,0.1)) + " years**."  if qeyrs_mf_2020!=.
	replace qeyrs_mf_2020_text = "Internationally comparable data on quality adjusted years of schooling are not available for " + wbcountrynameb + "." if qeyrs_mf_2020==.
	
	gen asr_mf_2020_text = ///
	"Across " + wbcountrynameb + ", **"  + strofreal(round(asr_mf_2020,1)) + " percent**" ///
	+ " of 15-year olds will survive until age 60. This statistic is a proxy for the range of health risks that a child born today would experience as an adult under current conditions." if asr_mf_2020!=.
	replace asr_mf_2020_text = "Internationally comparable data on adult survival are not available for " + wbcountrynameb + "." if asr_mf_2020==.
	
	gen nostu_mf_2020_text = ///
	"**" + strofreal(round(nostu_mf_2020,1)) + "** out of 100 children are **not** stunted." ///
	+ " **" + strofreal(round((100-nostu_mf_2020),1)) +  "** out of 100 children are at risk of cognitive and physical limitations that can last a lifetime." if nostu_mf_2020!=.
	replace nostu_mf_2020_text = "Internationally comparable data on stunting are not available for " + wbcountrynameb + "." if nostu_mf_2020==.
	
	// GENDER COMPARISON 
	
	gen gender_comp_1= ///
	cond((round(hci_f_2020,0.01))>(round(hci_m_2020,0.01)), "higher than", ///
	cond((round(hci_f_2020,0.01))<(round(hci_m_2020,0.01)), "lower than", ///
	"similar to the HCI")) if !missing(hci_f_2020, hci_m_2020)
	...
	*------------------------*
	gen uisger02f_text = ///
	cond(round(uisger02f)<round(uisger02f_reg) & round(uisger02f)<round(uisger02f_inc), /// 
	"The female pre-primary school gross enrollment ratio is **" + strofreal(round(uisger02f,1)) +" percent** *(" + strofreal(uisger02f_y) + ")*, lower than both the regional and income group averages. ", ///
	cond(round(uisger02f)>round(uisger02f_reg) & round(uisger02f)>round(uisger02f_inc), ///
	"The female pre-primary school gross enrollment ratio is **" + strofreal(round(uisger02f,1)) +" percent** *(" + strofreal(uisger02f_y) + ")*, higher than both the regional and income group averages. ", ///
	cond(round(uisger02f)>round(uisger02f_reg) & round(uisger02f)<round(uisger02f_inc), ///
	"The female pre-primary school gross enrollment ratio is **" + strofreal(round(uisger02f,1)) +" percent** *(" + strofreal(uisger02f_y) + ")*, higher than the regional average and lower than the income group average. ", ///
	cond(round(uisger02f)<round(uisger02f_reg) & round(uisger02f)>round(uisger02f_inc), ///
	"The female pre-primary school gross enrollment ratio is **" + strofreal(round(uisger02f,1)) +" percent** *(" + strofreal(uisger02f_y) + ")*, lower than the regional average and higher than the income group average. ", ///
	cond(round(uisger02f,1)==round(uisger02f_reg,1) & round(uisger02f,1)==round(uisger02f_inc,1), ///
	"The female pre-primary school gross enrollment ratio is **" + strofreal(round(uisger02f,1)) +" percent** *(" + strofreal(uisger02f_y) + ")*, similar to both the regional and income group averages. ", ///
	cond(round(uisger02f,1)==round(uisger02f_reg,1) & round(uisger02f,1)>round(uisger02f_inc,1), ///
	"The female pre-primary school gross enrollment ratio is **" + strofreal(round(uisger02f,1)) +" percent** *(" + strofreal(uisger02f_y) + ")*, similar to the regional average and higher than the income group average. ", ///
	cond(round(uisger02f,1)==round(uisger02f_reg,1) & round(uisger02f,1)<round(uisger02f_inc,1), ///
	"The female pre-primary school gross enrollment ratio is **" + strofreal(round(uisger02f,1)) +" percent** *(" + strofreal(uisger02f_y) + ")*, similar to the regional average and lower than the income group average. ", ///
	cond(round(uisger02f,1)>round(uisger02f_reg,1) & round(uisger02f,1)==round(uisger02f_inc,1), ///
	"The female pre-primary school gross enrollment ratio is **" + strofreal(round(uisger02f,1)) +" percent** *(" + strofreal(uisger02f_y) + ")*, similar to the income group average and higher than the regional average. ", ///
	cond(round(uisger02f,1)<round(uisger02f_reg,1) & round(uisger02f,1)==round(uisger02f_inc,1), ///
	"The female pre-primary school gross enrollment ratio is **" + strofreal(round(uisger02f,1)) +" percent** *(" + strofreal(uisger02f_y) + ")*, similar to the income group average and lower than the regional average. ", ///
	""))))))))) if uisger02f!=.
	replace uisger02f_text = "Internationally comparable data on female pre-primary school gross enrollment ratio are not available for " + wbcountrynameb + "." if uisger02f==.
	
	*------------------------*
	*Pre-primary gross enrollment ratio, male
	*------------------------*
	gen uisger02m_text = ///
	cond(round(uisger02m)<round(uisger02m_reg) & round(uisger02m)<round(uisger02m_inc), /// 
	"The male pre-primary school gross enrollment ratio is **" + strofreal(round(uisger02m,1)) +" percent** *(" + strofreal(uisger02m_y) + ")*, lower than both the regional and income group averages. ", ///
	cond(round(uisger02m)>round(uisger02m_reg) & round(uisger02m)>round(uisger02m_inc), ///
	"The male pre-primary school gross enrollment ratio is **" + strofreal(round(uisger02m,1)) +" percent** *(" + strofreal(uisger02m_y) + ")*, higher than both the regional and income group averages. ", ///
	cond(round(uisger02m)>round(uisger02m_reg) & round(uisger02m)<round(uisger02m_inc), ///
	"The male pre-primary school gross enrollment ratio is **" + strofreal(round(uisger02m,1)) +" percent** *(" + strofreal(uisger02m_y) + ")*, higher than the regional average and lower than the income group average. ", ///
	cond(round(uisger02m)<round(uisger02m_reg) & round(uisger02m)>round(uisger02m_inc), ///
	"The male pre-primary school gross enrollment ratio is **" + strofreal(round(uisger02m,1)) +" percent** *(" + strofreal(uisger02m_y) + ")*, lower than the regional average and higher than the income group average. ", ///
	cond(round(uisger02m,1)==round(uisger02m_reg,1) & round(uisger02m,1)==round(uisger02m_inc,1), ///
	"The male pre-primary school gross enrollment ratio is **" + strofreal(round(uisger02m,1)) +" percent** *(" + strofreal(uisger02m_y) + ")*, similar to both the regional and income group averages. ", ///
	cond(round(uisger02m,1)==round(uisger02m_reg,1) & round(uisger02m,1)>round(uisger02m_inc,1), ///
	"The male pre-primary school gross enrollment ratio is **" + strofreal(round(uisger02m,1)) +" percent** *(" + strofreal(uisger02m_y) + ")*, similar to the regional average and higher than the income group average. ", ///
	cond(round(uisger02m,1)==round(uisger02m_reg,1) & round(uisger02m,1)<round(uisger02m_inc,1), ///
	"The male pre-primary school gross enrollment ratio is **" + strofreal(round(uisger02m,1)) +" percent** *(" + strofreal(uisger02m_y) + ")*, similar to the regional average and lower than the income group average. ", ///
	cond(round(uisger02m,1)>round(uisger02m_reg,1) & round(uisger02m,1)==round(uisger02m_inc,1), ///
	"The male pre-primary school gross enrollment ratio is **" + strofreal(round(uisger02m,1)) +" percent** *(" + strofreal(uisger02m_y) + ")*, similar to the income group average and higher than the regional average. ", ///
	cond(round(uisger02m,1)<round(uisger02m_reg,1) & round(uisger02m,1)==round(uisger02m_inc,1), ///
	"The male pre-primary school gross enrollment ratio is **" + strofreal(round(uisger02m,1)) +" percent** *(" + strofreal(uisger02m_y) + ")*, similar to the income group average and lower than the regional average. ", ///
	""))))))))) if uisger02m!=.
	replace uisger02m_text = "Internationally comparable data on male pre-primary school gross enrollment ratio are not available for " + wbcountrynameb + "." if uisger02m==.
	...
	*------------------------*
	gen uiscr1f_text = ///
	cond(round(uiscr1f)<round(uiscr1f_reg) & round(uiscr1f)<round(uiscr1f_inc), /// 
	"Female primary school completion rate is **" + strofreal(round(uiscr1f,1)) + " percent** *(" + strofreal(uiscr1f_y) + ")*, lower than both the regional (" + strofreal(round(uiscr1f_reg,1)) + "%) and income group (" + strofreal(round(uiscr1f_inc,1)) + "%) averages. ", ///
	cond(round(uiscr1f)>round(uiscr1f_reg) & round(uiscr1f)>round(uiscr1f_inc), ///
	"Female primary school completion rate is **" + strofreal(round(uiscr1f,1)) + " percent** *(" + strofreal(uiscr1f_y) + ")*, higher than both the regional (" + strofreal(round(uiscr1f_reg,1)) + "%) and income group (" + strofreal(round(uiscr1f_inc,1)) + "%) averages. ", ///
	cond(round(uiscr1f)>round(uiscr1f_reg) & round(uiscr1f)<round(uiscr1f_inc), ///
	"Female primary school completion rate is **" + strofreal(round(uiscr1f,1)) + " percent** *(" + strofreal(uiscr1f_y) + ")*, higher than the regional average (" + strofreal(round(uiscr1f_reg,1)) + "%) and lower than the income group average (" + strofreal(round(uiscr1f_inc,1)) + "%). ", ///
	cond(round(uiscr1f)<round(uiscr1f_reg) & round(uiscr1f)>round(uiscr1f_inc), ///
	"Female primary school completion rate is **" + strofreal(round(uiscr1f,1)) + " percent** *(" + strofreal(uiscr1f_y) + ")*, lower than the regional average (" + strofreal(round(uiscr1f_reg,1)) + "%) and higher than the income group average (" + strofreal(round(uiscr1f_inc,1)) + "%). ", ///
	cond(round(uiscr1f,1)==round(uiscr1f_reg,1) & round(uiscr1f,1)==round(uiscr1f_inc,1), ///
	"Female primary school completion rate is **" + strofreal(round(uiscr1f,1)) + " percent** *(" + strofreal(uiscr1f_y) + ")*, similar to both the regional (" + strofreal(round(uiscr1f_reg,1)) + "%) and income group (" + strofreal(round(uiscr1f_inc,1)) + "%) averages. ", ///
	cond(round(uiscr1f,1)==round(uiscr1f_reg,1) & round(uiscr1f,1)>round(uiscr1f_inc,1), ///
	"Female primary school completion rate is **" + strofreal(round(uiscr1f,1)) + " percent** *(" + strofreal(uiscr1f_y) + ")*, similar to the regional average (" + strofreal(round(uiscr1f_reg,1)) + "%) and higher than the income group average (" + strofreal(round(uiscr1f_inc,1)) + "%). ", ///
	cond(round(uiscr1f,1)==round(uiscr1f_reg,1) & round(uiscr1f,1)<round(uiscr1f_inc,1), ///
	"Female primary school completion rate is **" + strofreal(round(uiscr1f,1)) + " percent** *(" + strofreal(uiscr1f_y) + ")*, similar to the regional average (" + strofreal(round(uiscr1f_reg,1)) + "%) and lower than the income group average (" + strofreal(round(uiscr1f_inc,1)) + "%). ", ///
	cond(round(uiscr1f,1)>round(uiscr1f_reg,1) & round(uiscr1f,1)==round(uiscr1f_inc,1), ///
	"Female primary school completion rate is **" + strofreal(round(uiscr1f,1)) + " percent** *(" + strofreal(uiscr1f_y) + ")*, higher than the regional average (" + strofreal(round(uiscr1f_reg,1)) + "%) and similar to the income group average (" + strofreal(round(uiscr1f_inc,1)) + "%). ", ///
	cond(round(uiscr1f,1)<round(uiscr1f_reg,1) & round(uiscr1f,1)==round(uiscr1f_inc,1), ///
	"Female primary school completion rate is **" + strofreal(round(uiscr1f,1)) + " percent** *(" + strofreal(uiscr1f_y) + ")*, lower than the regional average (" + strofreal(round(uiscr1f_reg,1)) + "%) and similar to the income group average (" + strofreal(round(uiscr1f_inc,1)) + "%). ", ///
	""))))))))) if uiscr1f!=.
	replace uiscr1f_text = "Internationally comparable data on female primary school completion rate are not available for " + wbcountrynameb + "." if uiscr1f==.
	
	*------------------------*
	*Primary completion rate (%), male
	*------------------------*
	gen uiscr1m_text = ///
	cond(round(uiscr1m)<round(uiscr1m_reg) & round(uiscr1m)<round(uiscr1m_inc), /// 
	"Male primary school completion rate is **" + strofreal(round(uiscr1m,1)) + " percent** *(" + strofreal(uiscr1m_y) + ")*, lower than both the regional (" + strofreal(round(uiscr1m_reg,1)) + "%) and income group (" + strofreal(round(uiscr1m_inc,1)) + "%) averages. ", ///
	cond(round(uiscr1m)>round(uiscr1m_reg) & round(uiscr1m)>round(uiscr1m_inc), ///
	"Male primary school completion rate is **" + strofreal(round(uiscr1m,1)) + " percent** *(" + strofreal(uiscr1m_y) + ")*, higher than both the regional (" + strofreal(round(uiscr1m_reg,1)) + "%) and income group (" + strofreal(round(uiscr1m_inc,1)) + "%) averages. ", ///
	cond(round(uiscr1m)>round(uiscr1m_reg) & round(uiscr1m)<round(uiscr1m_inc), ///
	"Male primary school completion rate is **" + strofreal(round(uiscr1m,1)) + " percent** *(" + strofreal(uiscr1m_y) + ")*, higher than the regional average (" + strofreal(round(uiscr1m_reg,1)) + "%) and lower than the income group average (" + strofreal(round(uiscr1m_inc,1)) + "%). ", ///
	cond(round(uiscr1m)<round(uiscr1m_reg) & round(uiscr1m)>round(uiscr1m_inc), ///
	"Male primary school completion rate is **" + strofreal(round(uiscr1m,1)) + " percent** *(" + strofreal(uiscr1m_y) + ")*, lower than the regional average (" + strofreal(round(uiscr1m_reg,1)) + "%) and higher than the income group average (" + strofreal(round(uiscr1m_inc,1)) + "%). ", ///
	cond(round(uiscr1m,1)==round(uiscr1m_reg,1) & round(uiscr1m,1)==round(uiscr1m_inc,1), ///
	"Male primary school completion rate is **" + strofreal(round(uiscr1m,1)) + " percent** *(" + strofreal(uiscr1m_y) + ")*, similar to both the regional (" + strofreal(round(uiscr1m_reg,1)) + "%) and income group (" + strofreal(round(uiscr1m_inc,1)) + "%) averages. ", ///
	cond(round(uiscr1m,1)==round(uiscr1m_reg,1) & round(uiscr1m,1)>round(uiscr1m_inc,1), ///
	"Male primary school completion rate is **" + strofreal(round(uiscr1m,1)) + " percent** *(" + strofreal(uiscr1m_y) + ")*, similar to the regional average (" + strofreal(round(uiscr1m_reg,1)) + "%) and higher than the income group average (" + strofreal(round(uiscr1m_inc,1)) + "%). ", ///
	cond(round(uiscr1m,1)==round(uiscr1m_reg,1) & round(uiscr1m,1)<round(uiscr1m_inc,1), ///
	"Male primary school completion rate is **" + strofreal(round(uiscr1m,1)) + " percent** *(" + strofreal(uiscr1m_y) + ")*, similar to the regional average (" + strofreal(round(uiscr1m_reg,1)) + "%) and lower than the income group average (" + strofreal(round(uiscr1m_inc,1)) + "%). ", ///
	cond(round(uiscr1m,1)>round(uiscr1m_reg,1) & round(uiscr1m,1)==round(uiscr1m_inc,1), ///
	"Male primary school completion rate is **" + strofreal(round(uiscr1m,1)) + " percent** *(" + strofreal(uiscr1m_y) + ")*, higher than the regional average (" + strofreal(round(uiscr1m_reg,1)) + "%) and similar to the income group average (" + strofreal(round(uiscr1m_inc,1)) + "%). ", ///
	cond(round(uiscr1m,1)<round(uiscr1m_reg,1) & round(uiscr1m,1)==round(uiscr1m_inc,1), ///
	"Male primary school completion rate is **" + strofreal(round(uiscr1m,1)) + " percent** *(" + strofreal(uiscr1m_y) + ")*, lower than the regional average (" + strofreal(round(uiscr1m_reg,1)) + "%) and similar to the income group average (" + strofreal(round(uiscr1m_inc,1)) + "%). ", ///
	""))))))))) if uiscr1m!=.
	replace uiscr1m_text = "Internationally comparable data on male primary school completion rate are not available for " + wbcountrynameb + "." if uiscr1m==.
	...
	*------------------------*
	gen se_lpv_prim_fe_text = ///
	cond(round(se_lpv_prim_fe)<round(se_lpv_prim_fe_reg) & round(se_lpv_prim_fe)<round(se_lpv_prim_fe_inc), /// 
	"**" + strofreal(round(se_lpv_prim_fe,1)) + " percent** *(" + strofreal(se_lpv_prim_fe_y) + ")* of 10-year-old girls cannot read and understand a simple text by the end of primary school, compared to " + strofreal(round(se_lpv_prim_fe_reg,1)) + " percent at the regional level and " + strofreal(round(se_lpv_prim_fe_inc,1)) + " percent at the income group level. ", ///
	cond(round(se_lpv_prim_fe)>round(se_lpv_prim_fe_reg) & round(se_lpv_prim_fe)>round(se_lpv_prim_fe_inc), ///
	"**" + strofreal(round(se_lpv_prim_fe,1)) + " percent** *(" + strofreal(se_lpv_prim_fe_y) + ")* of 10-year-old girls cannot read and understand a simple text by the end of primary school, compared to " + strofreal(round(se_lpv_prim_fe_reg,1)) + " percent at the regional level and " + strofreal(round(se_lpv_prim_fe_inc,1)) + " percent at the income group level. ", ///
	cond(round(se_lpv_prim_fe)>round(se_lpv_prim_fe_reg) & round(se_lpv_prim_fe)<round(se_lpv_prim_fe_inc), ///
	"**" + strofreal(round(se_lpv_prim_fe,1)) + " percent** *(" + strofreal(se_lpv_prim_fe_y) + ")* of 10-year-old girls cannot read and understand a simple text by the end of primary school, compared to " + strofreal(round(se_lpv_prim_fe_reg,1)) + " percent at the regional level and " + strofreal(round(se_lpv_prim_fe_inc,1)) + " percent at the income group level. ", ///
	cond(round(se_lpv_prim_fe)<round(se_lpv_prim_fe_reg) & round(se_lpv_prim_fe)>round(se_lpv_prim_fe_inc), ///
	"**" + strofreal(round(se_lpv_prim_fe,1)) + " percent** *(" + strofreal(se_lpv_prim_fe_y) + ")* of 10-year-old girls cannot read and understand a simple text by the end of primary school, compared to " + strofreal(round(se_lpv_prim_fe_reg,1)) + " percent at the regional level and " + strofreal(round(se_lpv_prim_fe_inc,1)) + " percent at the income group level. ", ///
	cond(round(se_lpv_prim_fe,1)==round(se_lpv_prim_fe_reg,1) & round(se_lpv_prim_fe,1)==round(se_lpv_prim_fe_inc,1), ///
	"**" + strofreal(round(se_lpv_prim_fe,1)) + " percent** *(" + strofreal(se_lpv_prim_fe_y) + ")* of 10-year-old girls cannot read and understand a simple text by the end of primary school, compared to " + strofreal(round(se_lpv_prim_fe_reg,1)) + " percent at the regional level and " + strofreal(round(se_lpv_prim_fe_inc,1)) + " percent at the income group level. ", ///
	cond(round(se_lpv_prim_fe,1)==round(se_lpv_prim_fe_reg,1) & round(se_lpv_prim_fe,1)>round(se_lpv_prim_fe_inc,1), ///
	"**" + strofreal(round(se_lpv_prim_fe,1)) + " percent** *(" + strofreal(se_lpv_prim_fe_y) + ")* of 10-year-old girls cannot read and understand a simple text by the end of primary school, compared to " + strofreal(round(se_lpv_prim_fe_reg,1)) + " percent at the regional level and " + strofreal(round(se_lpv_prim_fe_inc,1)) + " percent at the income group level. ", ///
	cond(round(se_lpv_prim_fe,1)==round(se_lpv_prim_fe_reg,1) & round(se_lpv_prim_fe,1)<round(se_lpv_prim_fe_inc,1), ///
	...
	"**" + strofreal(round(se_lpv_prim_fe,1)) + " percent** *(" + strofreal(se_lpv_prim_fe_y) + ")* of 10-year-old girls cannot read and understand a simple text by the end of primary school, compared to " + strofreal(round(se_lpv_prim_fe_reg,1)) + " percent at the regional level and " + strofreal(round(se_lpv_prim_fe_inc,1)) + " percent at the income group level. ", ///
	""))))))))) if se_lpv_prim_fe!=.
	replace se_lpv_prim_fe_text = "Internationally comparable data on female learning poverty are not available for " + wbcountrynameb + "." if se_lpv_prim_fe==.
	
	*------------------------*
	*Learning poverty (%), male
	*------------------------*
	gen se_lpv_prim_ma_text = ///
	cond(round(se_lpv_prim_ma)<round(se_lpv_prim_ma_reg) & round(se_lpv_prim_ma)<round(se_lpv_prim_ma_inc), /// 
	"And **" + strofreal(round(se_lpv_prim_ma,1)) + " percent** *(" + strofreal(se_lpv_prim_ma_y) + ")* of 10-year-old boys cannot read and understand a simple text by the end of primary school, compared to " + strofreal(round(se_lpv_prim_ma_reg,1)) + " percent at the regional level and " + strofreal(round(se_lpv_prim_ma_inc,1)) + " percent at the income group level. ", ///
	cond(round(se_lpv_prim_ma)>round(se_lpv_prim_ma_reg) & round(se_lpv_prim_ma)>round(se_lpv_prim_ma_inc), ///
	"And **" + strofreal(round(se_lpv_prim_ma,1)) + " percent** *(" + strofreal(se_lpv_prim_ma_y) + ")* of 10-year-old boys cannot read and understand a simple text by the end of primary school, compared to " + strofreal(round(se_lpv_prim_ma_reg,1)) + " percent at the regional level and " + strofreal(round(se_lpv_prim_ma_inc,1)) + " percent at the income group level. ", ///
	cond(round(se_lpv_prim_ma)>round(se_lpv_prim_ma_reg) & round(se_lpv_prim_ma)<round(se_lpv_prim_ma_inc), ///
	"And **" + strofreal(round(se_lpv_prim_ma,1)) + " percent** *(" + strofreal(se_lpv_prim_ma_y) + ")* of 10-year-old boys cannot read and understand a simple text by the end of primary school, compared to " + strofreal(round(se_lpv_prim_ma_reg,1)) + " percent at the regional level and " + strofreal(round(se_lpv_prim_ma_inc,1)) + " percent at the income group level. ", ///
	cond(round(se_lpv_prim_ma)<round(se_lpv_prim_ma_reg) & round(se_lpv_prim_ma)>round(se_lpv_prim_ma_inc), ///
	"And **" + strofreal(round(se_lpv_prim_ma,1)) + " percent** *(" + strofreal(se_lpv_prim_ma_y) + ")* of 10-year-old boys cannot read and understand a simple text by the end of primary school, compared to " + strofreal(round(se_lpv_prim_ma_reg,1)) + " percent at the regional level and " + strofreal(round(se_lpv_prim_ma_inc,1)) + " percent at the income group level. ", ///
	cond(round(se_lpv_prim_ma,1)==round(se_lpv_prim_ma_reg,1) & round(se_lpv_prim_ma,1)==round(se_lpv_prim_ma_inc,1), ///
	"And **" + strofreal(round(se_lpv_prim_ma,1)) + " percent** *(" + strofreal(se_lpv_prim_ma_y) + ")* of 10-year-old boys cannot read and understand a simple text by the end of primary school, compared to " + strofreal(round(se_lpv_prim_ma_reg,1)) + " percent at the regional level and " + strofreal(round(se_lpv_prim_ma_inc,1)) + " percent at the income group level. ", ///
	cond(round(se_lpv_prim_ma,1)==round(se_lpv_prim_ma_reg,1) & round(se_lpv_prim_ma,1)>round(se_lpv_prim_ma_inc,1), ///
	"And **" + strofreal(round(se_lpv_prim_ma,1)) + " percent** *(" + strofreal(se_lpv_prim_ma_y) + ")* of 10-year-old boys cannot read and understand a simple text by the end of primary school, compared to " + strofreal(round(se_lpv_prim_ma_reg,1)) + " percent at the regional level and " + strofreal(round(se_lpv_prim_ma_inc,1)) + " percent at the income group level. ", ///
	cond(round(se_lpv_prim_ma,1)==round(se_lpv_prim_ma_reg,1) & round(se_lpv_prim_ma,1)<round(se_lpv_prim_ma_inc,1), ///
	...
	"And **" + strofreal(round(se_lpv_prim_ma,1)) + " percent** *(" + strofreal(se_lpv_prim_ma_y) + ")* of 10-year-old boys cannot read and understand a simple text by the end of primary school, compared to " + strofreal(round(se_lpv_prim_ma_reg,1)) + " percent at the regional level and " + strofreal(round(se_lpv_prim_ma_inc,1)) + " percent at the income group level. ", ///
	""))))))))) if se_lpv_prim_ma!=.
	replace se_lpv_prim_ma_text = "Internationally comparable data on male learning poverty are not available for " + wbcountrynameb + "." if se_lpv_prim_ma==.
	...
	*------------------------*
	gen eip_neet_f_y_text = ///
	cond(round(eip_neet_f_y)<round(eip_neet_f_y_reg) & round(eip_neet_f_y)<round(eip_neet_f_y_inc), /// 
	"**" + strofreal(round(eip_neet_f_y,1)) +" percent** *(" + strofreal(eip_neet_f_y_y) + ")* of the female youth is not in employment, education or training. This is lower than both the average for its region (" + strofreal(round(eip_neet_f_y_reg,1)) + "%) and the average for its income group (" + strofreal(round(eip_neet_f_y_inc,1)) + "%). ", ///
	cond(round(eip_neet_f_y)>round(eip_neet_f_y_reg) & round(eip_neet_f_y)>round(eip_neet_f_y_inc), ///
	"**" + strofreal(round(eip_neet_f_y,1)) +" percent** *(" + strofreal(eip_neet_f_y_y) + ")* of the female youth is not in employment, education or training. This is higher than both the average for its region (" + strofreal(round(eip_neet_f_y_reg,1)) + "%) and the average for its income group (" + strofreal(round(eip_neet_f_y_inc,1)) + "%). ", ///
	cond(round(eip_neet_f_y)>round(eip_neet_f_y_reg) & round(eip_neet_f_y)<round(eip_neet_f_y_inc), ///
	"**" + strofreal(round(eip_neet_f_y,1)) +" percent** *(" + strofreal(eip_neet_f_y_y) + ")* of the female youth is not in employment, education or training. This is higher than the average for its region (" + strofreal(round(eip_neet_f_y_reg,1)) + "%) and lower than the average for its income group (" + strofreal(round(eip_neet_f_y_inc,1)) + "%). ", ///
	cond(round(eip_neet_f_y)<round(eip_neet_f_y_reg) & round(eip_neet_f_y)>round(eip_neet_f_y_inc), ///
	"**" + strofreal(round(eip_neet_f_y,1)) +" percent** *(" + strofreal(eip_neet_f_y_y) + ")* of the female youth is not in employment, education or training. This is lower than the average for its region (" + strofreal(round(eip_neet_f_y_reg,1)) + "%) and higher than the average for its income group (" + strofreal(round(eip_neet_f_y_inc,1)) + "%). ", ///
	cond(round(eip_neet_f_y,1)==round(eip_neet_f_y_reg,1) & round(eip_neet_f_y,1)==round(eip_neet_f_y_inc,1), ///
	"**" + strofreal(round(eip_neet_f_y,1)) +" percent** *(" + strofreal(eip_neet_f_y_y) + ")* of the female youth is not in employment, education or training. This is similar to both the average for its region (" + strofreal(round(eip_neet_f_y_reg,1)) + "%) and for its income group (" + strofreal(round(eip_neet_f_y_inc,1)) + "%). ", ///
	cond(round(eip_neet_f_y,1)==round(eip_neet_f_y_reg,1) & round(eip_neet_f_y,1)>round(eip_neet_f_y_inc,1), ///
	"**" + strofreal(round(eip_neet_f_y,1)) +" percent** *(" + strofreal(eip_neet_f_y_y) + ")* of the female youth is not in employment, education or training. This is similar to the average for its region (" + strofreal(round(eip_neet_f_y_reg,1)) + "%) and higher than the average for its income group (" + strofreal(round(eip_neet_f_y_inc,1)) + "%). ", ///
	cond(round(eip_neet_f_y,1)==round(eip_neet_f_y_reg,1) & round(eip_neet_f_y,1)<round(eip_neet_f_y_inc,1), ///
	"**" + strofreal(round(eip_neet_f_y,1)) +" percent** *(" + strofreal(eip_neet_f_y_y) + ")* of the female youth is not in employment, education or training. This is similar to the average for its region (" + strofreal(round(eip_neet_f_y_reg,1)) + "%) and lower than the average for its income group (" + strofreal(round(eip_neet_f_y_inc,1)) + "%). ", ///
	cond(round(eip_neet_f_y,1)>round(eip_neet_f_y_reg,1) & round(eip_neet_f_y,1)==round(eip_neet_f_y_inc,1), ///
	"**" + strofreal(round(eip_neet_f_y,1)) +" percent** *(" + strofreal(eip_neet_f_y_y) + ")* of the female youth is not in employment, education or training. This is higher than the average for its region (" + strofreal(round(eip_neet_f_y_reg,1)) + "%) and similar to the average for its income group (" + strofreal(round(eip_neet_f_y_inc,1)) + "%). ", ///
	cond(round(eip_neet_f_y,1)<round(eip_neet_f_y_reg,1) & round(eip_neet_f_y,1)==round(eip_neet_f_y_inc,1), ///
	"**" + strofreal(round(eip_neet_f_y,1)) +" percent** *(" + strofreal(eip_neet_f_y_y) + ")* of the female youth is not in employment, education or training. This is lower than the average for its region (" + strofreal(round(eip_neet_f_y_reg,1)) + "%) and similar to the average for its income group (" + strofreal(round(eip_neet_f_y_inc,1)) + "%). ", ///
	""))))))))) if eip_neet_f_y!=.
	replace eip_neet_f_y_text = "Internationally comparable data on female youth not in employment, education or training are not available for " + wbcountrynameb + "." if eip_neet_f_y==.
	
	*------------------------*
	*Youth NEET (% ages 15-24), male
	*------------------------*
	gen eip_neet_m_y_text = ///
	cond(round(eip_neet_m_y)<round(eip_neet_m_y_reg) & round(eip_neet_m_y)<round(eip_neet_m_y_inc), /// 
	"And, **" + strofreal(round(eip_neet_m_y,1)) +" percent** *(" + strofreal(eip_neet_m_y_y) + ")* of the male youth is not in employment, education or training. This is lower than both the average for its region (" + strofreal(round(eip_neet_m_y_reg,1)) + "%) and the average for its income group (" + strofreal(round(eip_neet_m_y_inc,1)) + "%). ", ///
	cond(round(eip_neet_m_y)>round(eip_neet_m_y_reg) & round(eip_neet_m_y)>round(eip_neet_m_y_inc), ///
	"And, **" + strofreal(round(eip_neet_m_y,1)) +" percent** *(" + strofreal(eip_neet_m_y_y) + ")* of the male youth is not in employment, education or training. This is higher than both the average for its region (" + strofreal(round(eip_neet_m_y_reg,1)) + "%) and the average for its income group (" + strofreal(round(eip_neet_m_y_inc,1)) + "%). ", ///
	cond(round(eip_neet_m_y)>round(eip_neet_m_y_reg) & round(eip_neet_m_y)<round(eip_neet_m_y_inc), ///
	"And, **" + strofreal(round(eip_neet_m_y,1)) +" percent** *(" + strofreal(eip_neet_m_y_y) + ")* of the male youth is not in employment, education or training. This is higher than the average for its region (" + strofreal(round(eip_neet_m_y_reg,1)) + "%) and lower than the average for its income group (" + strofreal(round(eip_neet_m_y_inc,1)) + "%). ", ///
	cond(round(eip_neet_m_y)<round(eip_neet_m_y_reg) & round(eip_neet_m_y)>round(eip_neet_m_y_inc), ///
	"And, **" + strofreal(round(eip_neet_m_y,1)) +" percent** *(" + strofreal(eip_neet_m_y_y) + ")* of the male youth is not in employment, education or training. This is lower than the average for its region (" + strofreal(round(eip_neet_m_y_reg,1)) + "%) and higher than the average for its income group (" + strofreal(round(eip_neet_m_y_inc,1)) + "%). ", ///
	cond(round(eip_neet_m_y,1)==round(eip_neet_m_y_reg,1) & round(eip_neet_m_y,1)==round(eip_neet_m_y_inc,1), ///
	"And, **" + strofreal(round(eip_neet_m_y,1)) +" percent** *(" + strofreal(eip_neet_m_y_y) + ")* of the male youth is not in employment, education or training. This is similar to both the average for its region (" + strofreal(round(eip_neet_m_y_reg,1)) + "%) and for its income group (" + strofreal(round(eip_neet_m_y_inc,1)) + "%). ", ///
	cond(round(eip_neet_m_y,1)==round(eip_neet_m_y_reg,1) & round(eip_neet_m_y,1)>round(eip_neet_m_y_inc,1), ///
	"And, **" + strofreal(round(eip_neet_m_y,1)) +" percent** *(" + strofreal(eip_neet_m_y_y) + ")* of the male youth is not in employment, education or training. This is similar to the average for its region (" + strofreal(round(eip_neet_m_y_reg,1)) + "%) and higher than the average for its income group (" + strofreal(round(eip_neet_m_y_inc,1)) + "%). ", ///
	cond(round(eip_neet_m_y,1)==round(eip_neet_m_y_reg,1) & round(eip_neet_m_y,1)<round(eip_neet_m_y_inc,1), ///
	"And, **" + strofreal(round(eip_neet_m_y,1)) +" percent** *(" + strofreal(eip_neet_m_y_y) + ")* of the male youth is not in employment, education or training. This is similar to the average for its region (" + strofreal(round(eip_neet_m_y_reg,1)) + "%) and lower than the average for its income group (" + strofreal(round(eip_neet_m_y_inc,1)) + "%). ", ///
	cond(round(eip_neet_m_y,1)>round(eip_neet_m_y_reg,1) & round(eip_neet_m_y,1)==round(eip_neet_m_y_inc,1), ///
	"And, **" + strofreal(round(eip_neet_m_y,1)) +" percent** *(" + strofreal(eip_neet_m_y_y) + ")* of the male youth is not in employment, education or training. This is higher than the average for its region (" + strofreal(round(eip_neet_m_y_reg,1)) + "%) and similar to the average for its income group (" + strofreal(round(eip_neet_m_y_inc,1)) + "%). ", ///
	cond(round(eip_neet_m_y,1)<round(eip_neet_m_y_reg,1) & round(eip_neet_m_y,1)==round(eip_neet_m_y_inc,1), ///
	"And, **" + strofreal(round(eip_neet_m_y,1)) +" percent** *(" + strofreal(eip_neet_m_y_y) + ")* of the male youth is not in employment, education or training. This is lower than the average for its region (" + strofreal(round(eip_neet_m_y_reg,1)) + "%) and similar to the average for its income group (" + strofreal(round(eip_neet_m_y_inc,1)) + "%). ", ///
	""))))))))) if eip_neet_m_y!=.
	replace eip_neet_m_y_text = "Internationally comparable data on male youth not in employment, education or training are not available for " + wbcountrynameb + "." if eip_neet_m_y==.
	...
	*------------------------*
	gen une_2eap_f_y_text = ///
	cond(round(une_2eap_f_y)<round(une_2eap_f_y_reg) & round(une_2eap_f_y)<round(une_2eap_f_y_inc), /// 
	"Female youth unemployment is **" + strofreal(round(une_2eap_f_y,1)) + " percent** *(" + strofreal(une_2eap_f_y_y) + ")*, lower than both the regional (" + strofreal(round(une_2eap_f_y_reg,1)) + "%) and income group (" + strofreal(round(une_2eap_f_y_inc,1)) + "%) averages. ", ///
	cond(round(une_2eap_f_y)>round(une_2eap_f_y_reg) & round(une_2eap_f_y)>round(une_2eap_f_y_inc), ///
	"Female youth unemployment is **" + strofreal(round(une_2eap_f_y,1)) + " percent** *(" + strofreal(une_2eap_f_y_y) + ")*, higher than both the regional (" + strofreal(round(une_2eap_f_y_reg,1)) + "%) and income group (" + strofreal(round(une_2eap_f_y_inc,1)) + "%) averages. ", ///
	cond(round(une_2eap_f_y)>round(une_2eap_f_y_reg) & round(une_2eap_f_y)<round(une_2eap_f_y_inc), ///
	"Female youth unemployment is **" + strofreal(round(une_2eap_f_y,1)) + " percent** *(" + strofreal(une_2eap_f_y_y) + ")*, higher than the regional average (" + strofreal(round(une_2eap_f_y_reg,1)) + "%) and lower than the income group average (" + strofreal(round(une_2eap_f_y_inc,1)) + "%). ", ///
	cond(round(une_2eap_f_y)<round(une_2eap_f_y_reg) & round(une_2eap_f_y)>round(une_2eap_f_y_inc), ///
	"Female youth unemployment is **" + strofreal(round(une_2eap_f_y,1)) + " percent** *(" + strofreal(une_2eap_f_y_y) + ")*, lower than the regional average (" + strofreal(round(une_2eap_f_y_reg,1)) + "%) and higher than the income group average (" + strofreal(round(une_2eap_f_y_inc,1)) + "%). ", ///
	cond(round(une_2eap_f_y,1)==round(une_2eap_f_y_reg,1) & round(une_2eap_f_y,1)==round(une_2eap_f_y_inc,1), ///
	"Female youth unemployment is **" + strofreal(round(une_2eap_f_y,1)) + " percent** *(" + strofreal(une_2eap_f_y_y) + ")*, similar to both the regional (" + strofreal(round(une_2eap_f_y_reg,1)) + "%) and income group (" + strofreal(round(une_2eap_f_y_inc,1)) + "%) averages. ", ///
	cond(round(une_2eap_f_y,1)==round(une_2eap_f_y_reg,1) & round(une_2eap_f_y,1)>round(une_2eap_f_y_inc,1), ///
	"Female youth unemployment is **" + strofreal(round(une_2eap_f_y,1)) + " percent** *(" + strofreal(une_2eap_f_y_y) + ")*, similar to the regional average (" + strofreal(round(une_2eap_f_y_reg,1)) + "%) and higher than the income group average (" + strofreal(round(une_2eap_f_y_inc,1)) + "%). ", ///
	cond(round(une_2eap_f_y,1)==round(une_2eap_f_y_reg,1) & round(une_2eap_f_y,1)<round(une_2eap_f_y_inc,1), ///
	"Female youth unemployment is **" + strofreal(round(une_2eap_f_y,1)) + " percent** *(" + strofreal(une_2eap_f_y_y) + ")*, similar to the regional average (" + strofreal(round(une_2eap_f_y_reg,1)) + "%) and lower than the income group average (" + strofreal(round(une_2eap_f_y_inc,1)) + "%). ", ///
	cond(round(une_2eap_f_y,1)>round(une_2eap_f_y_reg,1) & round(une_2eap_f_y,1)==round(une_2eap_f_y_inc,1), ///
	"Female youth unemployment is **" + strofreal(round(une_2eap_f_y,1)) + " percent** *(" + strofreal(une_2eap_f_y_y) + ")*, higher than the regional average (" + strofreal(round(une_2eap_f_y_reg,1)) + "%) and similar to the income group average (" + strofreal(round(une_2eap_f_y_inc,1)) + "%). ", ///
	cond(round(une_2eap_f_y,1)<round(une_2eap_f_y_reg,1) & round(une_2eap_f_y,1)==round(une_2eap_f_y_inc,1), ///
	"Female youth unemployment is **" + strofreal(round(une_2eap_f_y,1)) + " percent** *(" + strofreal(une_2eap_f_y_y) + ")*, lower than the regional average (" + strofreal(round(une_2eap_f_y_reg,1)) + "%) and similar to the income group average (" + strofreal(round(une_2eap_f_y_inc,1)) + "%). ", ///
	""))))))))) if une_2eap_f_y!=.
	replace une_2eap_f_y_text = "Internationally comparable data on female youth unemployment are not available for " + wbcountrynameb + "." if une_2eap_f_y==.
	
	*------------------------*
	*Youth unemployment, male
	*------------------------*
	gen une_2eap_m_y_text = ///
	cond(round(une_2eap_m_y)<round(une_2eap_m_y_reg) & round(une_2eap_m_y)<round(une_2eap_m_y_inc), /// 
	"Male youth unemployment is **" + strofreal(round(une_2eap_m_y,1)) + " percent** *(" + strofreal(une_2eap_m_y_y) + ")*, lower than both the regional (" + strofreal(round(une_2eap_m_y_reg,1)) + "%) and income group (" + strofreal(round(une_2eap_m_y_inc,1)) + "%) averages. ", ///
	cond(round(une_2eap_m_y)>round(une_2eap_m_y_reg) & round(une_2eap_m_y)>round(une_2eap_m_y_inc), ///
	"Male youth unemployment is **" + strofreal(round(une_2eap_m_y,1)) + " percent** *(" + strofreal(une_2eap_m_y_y) + ")*, higher than both the regional (" + strofreal(round(une_2eap_m_y_reg,1)) + "%) and income group (" + strofreal(round(une_2eap_m_y_inc,1)) + "%) averages. ", ///
	cond(round(une_2eap_m_y)>round(une_2eap_m_y_reg) & round(une_2eap_m_y)<round(une_2eap_m_y_inc), ///
	"Male youth unemployment is **" + strofreal(round(une_2eap_m_y,1)) + " percent** *(" + strofreal(une_2eap_m_y_y) + ")*, higher than the regional average (" + strofreal(round(une_2eap_m_y_reg,1)) + "%) and lower than the income group average (" + strofreal(round(une_2eap_m_y_inc,1)) + "%). ", ///
	cond(round(une_2eap_m_y)<round(une_2eap_m_y_reg) & round(une_2eap_m_y)>round(une_2eap_m_y_inc), ///
	"Male youth unemployment is **" + strofreal(round(une_2eap_m_y,1)) + " percent** *(" + strofreal(une_2eap_m_y_y) + ")*, lower than the regional average (" + strofreal(round(une_2eap_m_y_reg,1)) + "%) and higher than the income group average (" + strofreal(round(une_2eap_m_y_inc,1)) + "%). ", ///
	cond(round(une_2eap_m_y,1)==round(une_2eap_m_y_reg,1) & round(une_2eap_m_y,1)==round(une_2eap_m_y_inc,1), ///
	"Male youth unemployment is **" + strofreal(round(une_2eap_m_y,1)) + " percent** *(" + strofreal(une_2eap_m_y_y) + ")*, similar to both the regional (" + strofreal(round(une_2eap_m_y_reg,1)) + "%) and income group (" + strofreal(round(une_2eap_m_y_inc,1)) + "%) averages. ", ///
	cond(round(une_2eap_m_y,1)==round(une_2eap_m_y_reg,1) & round(une_2eap_m_y,1)>round(une_2eap_m_y_inc,1), ///
	"Male youth unemployment is **" + strofreal(round(une_2eap_m_y,1)) + " percent** *(" + strofreal(une_2eap_m_y_y) + ")*, similar to the regional average (" + strofreal(round(une_2eap_m_y_reg,1)) + "%) and higher than the income group average (" + strofreal(round(une_2eap_m_y_inc,1)) + "%). ", ///
	cond(round(une_2eap_m_y,1)==round(une_2eap_m_y_reg,1) & round(une_2eap_m_y,1)<round(une_2eap_m_y_inc,1), ///
	"Male youth unemployment is **" + strofreal(round(une_2eap_m_y,1)) + " percent** *(" + strofreal(une_2eap_m_y_y) + ")*, similar to the regional average (" + strofreal(round(une_2eap_m_y_reg,1)) + "%) and lower than the income group average (" + strofreal(round(une_2eap_m_y_inc,1)) + "%). ", ///
	cond(round(une_2eap_m_y,1)>round(une_2eap_m_y_reg,1) & round(une_2eap_m_y,1)==round(une_2eap_m_y_inc,1), ///
	"Male youth unemployment is **" + strofreal(round(une_2eap_m_y,1)) + " percent** *(" + strofreal(une_2eap_m_y_y) + ")*, higher than the regional average (" + strofreal(round(une_2eap_m_y_reg,1)) + "%) and similar to the income group average (" + strofreal(round(une_2eap_m_y_inc,1)) + "%). ", ///
	cond(round(une_2eap_m_y,1)<round(une_2eap_m_y_reg,1) & round(une_2eap_m_y,1)==round(une_2eap_m_y_inc,1), ///
	"Male youth unemployment is **" + strofreal(round(une_2eap_m_y,1)) + " percent** *(" + strofreal(une_2eap_m_y_y) + ")*, lower than the regional average (" + strofreal(round(une_2eap_m_y_reg,1)) + "%) and similar to the income group average (" + strofreal(round(une_2eap_m_y_inc,1)) + "%). ", ///
	""))))))))) if une_2eap_m_y!=.
	replace une_2eap_m_y_text = "Internationally comparable data on male youth unemployment are not available for " + wbcountrynameb + "." if une_2eap_m_y==.
	...
	*------------------------*
	gen eap_2wap_f_a_text = ///
	cond(round(eap_2wap_f_a)<round(eap_2wap_f_a_reg) & round(eap_2wap_f_a)<round(eap_2wap_f_a_inc), /// 
	"The female labor force participation is **" + strofreal(round(eap_2wap_f_a,1)) + " percent** *(" + strofreal(eap_2wap_f_a_y) + ")*, lower than both the regional (" + strofreal(round(eap_2wap_f_a_reg,1)) + "%) and income group (" + strofreal(round(eap_2wap_f_a_inc,1)) + "%) averages. ", ///
	cond(round(eap_2wap_f_a)>round(eap_2wap_f_a_reg) & round(eap_2wap_f_a)>round(eap_2wap_f_a_inc), ///
	"The female labor force participation is **" + strofreal(round(eap_2wap_f_a,1)) + " percent** *(" + strofreal(eap_2wap_f_a_y) + ")*, higher than both the regional (" + strofreal(round(eap_2wap_f_a_reg,1)) + "%) and income group (" + strofreal(round(eap_2wap_f_a_inc,1)) + "%) averages. ", ///
	cond(round(eap_2wap_f_a)>round(eap_2wap_f_a_reg) & round(eap_2wap_f_a)<round(eap_2wap_f_a_inc), ///
	"The female labor force participation is **" + strofreal(round(eap_2wap_f_a,1)) + " percent** *(" + strofreal(eap_2wap_f_a_y) + ")*, higher than the regional average (" + strofreal(round(eap_2wap_f_a_reg,1)) + "%) and lower than the income group average (" + strofreal(round(eap_2wap_f_a_inc,1)) + "%). ", ///
	cond(round(eap_2wap_f_a)<round(eap_2wap_f_a_reg) & round(eap_2wap_f_a)>round(eap_2wap_f_a_inc), ///
	"The female labor force participation is **" + strofreal(round(eap_2wap_f_a,1)) + " percent** *(" + strofreal(eap_2wap_f_a_y) + ")*, lower than the regional average (" + strofreal(round(eap_2wap_f_a_reg,1)) + "%) and higher than the income group average (" + strofreal(round(eap_2wap_f_a_inc,1)) + "%). ", ///
	cond(round(eap_2wap_f_a,1)==round(eap_2wap_f_a_reg,1) & round(eap_2wap_f_a,1)==round(eap_2wap_f_a_inc,1), ///
	"The female labor force participation is **" + strofreal(round(eap_2wap_f_a,1)) + " percent** *(" + strofreal(eap_2wap_f_a_y) + ")*, similar to both the regional (" + strofreal(round(eap_2wap_f_a_reg,1)) + "%) and income group (" + strofreal(round(eap_2wap_f_a_inc,1)) + "%) averages. ", ///
	cond(round(eap_2wap_f_a,1)==round(eap_2wap_f_a_reg,1) & round(eap_2wap_f_a,1)>round(eap_2wap_f_a_inc,1), ///
	"The female labor force participation is **" + strofreal(round(eap_2wap_f_a,1)) + " percent** *(" + strofreal(eap_2wap_f_a_y) + ")*, similar to the regional average (" + strofreal(round(eap_2wap_f_a_reg,1)) + "%) and higher than the income group average (" + strofreal(round(eap_2wap_f_a_inc,1)) + "%). ", ///
	cond(round(eap_2wap_f_a,1)==round(eap_2wap_f_a_reg,1) & round(eap_2wap_f_a,1)<round(eap_2wap_f_a_inc,1), ///
	"The female labor force participation is **" + strofreal(round(eap_2wap_f_a,1)) + " percent** *(" + strofreal(eap_2wap_f_a_y) + ")*, similar to the regional average (" + strofreal(round(eap_2wap_f_a_reg,1)) + "%) and lower than the income group average (" + strofreal(round(eap_2wap_f_a_inc,1)) + "%). ", ///
	cond(round(eap_2wap_f_a,1)>round(eap_2wap_f_a_reg,1) & round(eap_2wap_f_a,1)==round(eap_2wap_f_a_inc,1), ///
	"The female labor force participation is **" + strofreal(round(eap_2wap_f_a,1)) + " percent** *(" + strofreal(eap_2wap_f_a_y) + ")*, higher than the regional average (" + strofreal(round(eap_2wap_f_a_reg,1)) + "%) and similar to the income group average (" + strofreal(round(eap_2wap_f_a_inc,1)) + "%). ", ///
	cond(round(eap_2wap_f_a,1)<round(eap_2wap_f_a_reg,1) & round(eap_2wap_f_a,1)==round(eap_2wap_f_a_inc,1), ///
	"The female labor force participation is **" + strofreal(round(eap_2wap_f_a,1)) + " percent** *(" + strofreal(eap_2wap_f_a_y) + ")*, lower than the regional average (" + strofreal(round(eap_2wap_f_a_reg,1)) + "%) and similar to the income group average (" + strofreal(round(eap_2wap_f_a_inc,1)) + "%). ", ///
	""))))))))) if eap_2wap_f_a!=.
	replace eap_2wap_f_a_text = "Internationally comparable data on female labor force participation are not available for " + wbcountrynameb + "." if eap_2wap_f_a==.
	
	*------------------------*
	*Male labor force participation
	*------------------------*
	gen eap_2wap_m_a_text = ///
	cond(round(eap_2wap_m_a)<round(eap_2wap_m_a_reg) & round(eap_2wap_m_a)<round(eap_2wap_m_a_inc), /// 
	"The male labor force participation is **" + strofreal(round(eap_2wap_m_a,1)) + " percent** *(" + strofreal(eap_2wap_m_a_y) + ")*, lower than both the regional (" + strofreal(round(eap_2wap_m_a_reg,1)) + "%) and income group (" + strofreal(round(eap_2wap_m_a_inc,1)) + "%) averages. ", ///
	cond(round(eap_2wap_m_a)>round(eap_2wap_m_a_reg) & round(eap_2wap_m_a)>round(eap_2wap_m_a_inc), ///
	"The male labor force participation is **" + strofreal(round(eap_2wap_m_a,1)) + " percent** *(" + strofreal(eap_2wap_m_a_y) + ")*, higher than both the regional (" + strofreal(round(eap_2wap_m_a_reg,1)) + "%) and income group (" + strofreal(round(eap_2wap_m_a_inc,1)) + "%) averages. ", ///
	cond(round(eap_2wap_m_a)>round(eap_2wap_m_a_reg) & round(eap_2wap_m_a)<round(eap_2wap_m_a_inc), ///
	"The male labor force participation is **" + strofreal(round(eap_2wap_m_a,1)) + " percent** *(" + strofreal(eap_2wap_m_a_y) + ")*, higher than the regional average (" + strofreal(round(eap_2wap_m_a_reg,1)) + "%) and lower than the income group average (" + strofreal(round(eap_2wap_m_a_inc,1)) + "%). ", ///
	cond(round(eap_2wap_m_a)<round(eap_2wap_m_a_reg) & round(eap_2wap_m_a)>round(eap_2wap_m_a_inc), ///
	"The male labor force participation is **" + strofreal(round(eap_2wap_m_a,1)) + " percent** *(" + strofreal(eap_2wap_m_a_y) + ")*, lower than the regional average (" + strofreal(round(eap_2wap_m_a_reg,1)) + "%) and higher than the income group average (" + strofreal(round(eap_2wap_m_a_inc,1)) + "%). ", ///
	cond(round(eap_2wap_m_a,1)==round(eap_2wap_m_a_reg,1) & round(eap_2wap_m_a,1)==round(eap_2wap_m_a_inc,1), ///
	"The male labor force participation is **" + strofreal(round(eap_2wap_m_a,1)) + " percent** *(" + strofreal(eap_2wap_m_a_y) + ")*, similar to both the regional (" + strofreal(round(eap_2wap_m_a_reg,1)) + "%) and income group (" + strofreal(round(eap_2wap_m_a_inc,1)) + "%) averages. ", ///
	cond(round(eap_2wap_m_a,1)==round(eap_2wap_m_a_reg,1) & round(eap_2wap_m_a,1)>round(eap_2wap_m_a_inc,1), ///
	"The male labor force participation is **" + strofreal(round(eap_2wap_m_a,1)) + " percent** *(" + strofreal(eap_2wap_m_a_y) + ")*, similar to the regional average (" + strofreal(round(eap_2wap_m_a_reg,1)) + "%) and higher than the income group average (" + strofreal(round(eap_2wap_m_a_inc,1)) + "%). ", ///
	cond(round(eap_2wap_m_a,1)==round(eap_2wap_m_a_reg,1) & round(eap_2wap_m_a,1)<round(eap_2wap_m_a_inc,1), ///
	"The male labor force participation is **" + strofreal(round(eap_2wap_m_a,1)) + " percent** *(" + strofreal(eap_2wap_m_a_y) + ")*, similar to the regional average (" + strofreal(round(eap_2wap_m_a_reg,1)) + "%) and lower than the income group average (" + strofreal(round(eap_2wap_m_a_inc,1)) + "%). ", ///
	cond(round(eap_2wap_m_a,1)>round(eap_2wap_m_a_reg,1) & round(eap_2wap_m_a,1)==round(eap_2wap_m_a_inc,1), ///
	"The male labor force participation is **" + strofreal(round(eap_2wap_m_a,1)) + " percent** *(" + strofreal(eap_2wap_m_a_y) + ")*, higher than the regional average (" + strofreal(round(eap_2wap_m_a_reg,1)) + "%) and similar to the income group average (" + strofreal(round(eap_2wap_m_a_inc,1)) + "%). ", ///
	cond(round(eap_2wap_m_a,1)<round(eap_2wap_m_a_reg,1) & round(eap_2wap_m_a,1)==round(eap_2wap_m_a_inc,1), ///
	"The male labor force participation is **" + strofreal(round(eap_2wap_m_a,1)) + " percent** *(" + strofreal(eap_2wap_m_a_y) + ")*, lower than the regional average (" + strofreal(round(eap_2wap_m_a_reg,1)) + "%) and similar to the income group average (" + strofreal(round(eap_2wap_m_a_inc,1)) + "%). ", ///
	""))))))))) if eap_2wap_m_a!=.
	replace eap_2wap_m_a_text = "Internationally comparable data on male labor force participation are not available for " + wbcountrynameb + "." if eap_2wap_m_a==.
	...
	*------------------------*
	gen sp_dyn_le00_fe_in_text = ///
	cond(round(sp_dyn_le00_fe_in)<round(sp_dyn_le00_fe_in_reg) & round(sp_dyn_le00_fe_in)<round(sp_dyn_le00_fe_in_inc), /// 
	"Female life expectancy at birth is **" + strofreal(round(sp_dyn_le00_fe_in,1)) + " years** *(" + strofreal(sp_dyn_le00_fe_in_y) + ")*, lower than both the regional (" + strofreal(round(sp_dyn_le00_fe_in_reg,1)) + " years) and income group (" + strofreal(round(sp_dyn_le00_fe_in_inc,1)) + " years) averages. ", ///
	cond(round(sp_dyn_le00_fe_in)>round(sp_dyn_le00_fe_in_reg) & round(sp_dyn_le00_fe_in)>round(sp_dyn_le00_fe_in_inc), ///
	"Female life expectancy at birth is **" + strofreal(round(sp_dyn_le00_fe_in,1)) + " years** *(" + strofreal(sp_dyn_le00_fe_in_y) + ")*, higher than both the regional (" + strofreal(round(sp_dyn_le00_fe_in_reg,1)) + " years) and income group (" + strofreal(round(sp_dyn_le00_fe_in_inc,1)) + " years) averages. ", ///
	cond(round(sp_dyn_le00_fe_in)>round(sp_dyn_le00_fe_in_reg) & round(sp_dyn_le00_fe_in)<round(sp_dyn_le00_fe_in_inc), ///
	"Female life expectancy at birth is **" + strofreal(round(sp_dyn_le00_fe_in,1)) + " years** *(" + strofreal(sp_dyn_le00_fe_in_y) + ")*, higher than the regional average (" + strofreal(round(sp_dyn_le00_fe_in_reg,1)) + " years) and lower than the income group average (" + strofreal(round(sp_dyn_le00_fe_in_inc,1)) + " years). ", ///
	cond(round(sp_dyn_le00_fe_in)<round(sp_dyn_le00_fe_in_reg) & round(sp_dyn_le00_fe_in)>round(sp_dyn_le00_fe_in_inc), ///
	"Female life expectancy at birth is **" + strofreal(round(sp_dyn_le00_fe_in,1)) + " years** *(" + strofreal(sp_dyn_le00_fe_in_y) + ")*, lower than the regional average (" + strofreal(round(sp_dyn_le00_fe_in_reg,1)) + " years) and higher than the income group average (" + strofreal(round(sp_dyn_le00_fe_in_inc,1)) + " years). ", ///
	cond(round(sp_dyn_le00_fe_in,1)==round(sp_dyn_le00_fe_in_reg,1) & round(sp_dyn_le00_fe_in,1)==round(sp_dyn_le00_fe_in_inc,1), ///
	"Female life expectancy at birth is **" + strofreal(round(sp_dyn_le00_fe_in,1)) + " years** *(" + strofreal(sp_dyn_le00_fe_in_y) + ")*, similar to both the regional (" + strofreal(round(sp_dyn_le00_fe_in_reg,1)) + " years) and income group (" + strofreal(round(sp_dyn_le00_fe_in_inc,1)) + " years) averages. ", ///
	cond(round(sp_dyn_le00_fe_in,1)==round(sp_dyn_le00_fe_in_reg,1) & round(sp_dyn_le00_fe_in,1)>round(sp_dyn_le00_fe_in_inc,1), ///
	"Female life expectancy at birth is **" + strofreal(round(sp_dyn_le00_fe_in,1)) + " years** *(" + strofreal(sp_dyn_le00_fe_in_y) + ")*, similar to the regional average (" + strofreal(round(sp_dyn_le00_fe_in_reg,1)) + " years) and higher than the income group average (" + strofreal(round(sp_dyn_le00_fe_in_inc,1)) + " years). ", ///
	cond(round(sp_dyn_le00_fe_in,1)==round(sp_dyn_le00_fe_in_reg,1) & round(sp_dyn_le00_fe_in,1)<round(sp_dyn_le00_fe_in_inc,1), ///
	"Female life expectancy at birth is **" + strofreal(round(sp_dyn_le00_fe_in,1)) + " years** *(" + strofreal(sp_dyn_le00_fe_in_y) + ")*, similar to the regional average (" + strofreal(round(sp_dyn_le00_fe_in_reg,1)) + " years) and lower than the income group average (" + strofreal(round(sp_dyn_le00_fe_in_inc,1)) + " years). ", ///
	cond(round(sp_dyn_le00_fe_in,1)>round(sp_dyn_le00_fe_in_reg,1) & round(sp_dyn_le00_fe_in,1)==round(sp_dyn_le00_fe_in_inc,1), ///
	"Female life expectancy at birth is **" + strofreal(round(sp_dyn_le00_fe_in,1)) + " years** *(" + strofreal(sp_dyn_le00_fe_in_y) + ")*, higher than the regional average (" + strofreal(round(sp_dyn_le00_fe_in_reg,1)) + " years) and similar to the income group average (" + strofreal(round(sp_dyn_le00_fe_in_inc,1)) + " years). ", ///
	cond(round(sp_dyn_le00_fe_in,1)<round(sp_dyn_le00_fe_in_reg,1) & round(sp_dyn_le00_fe_in,1)==round(sp_dyn_le00_fe_in_inc,1), ///
	"Female life expectancy at birth is **" + strofreal(round(sp_dyn_le00_fe_in,1)) + " years** *(" + strofreal(sp_dyn_le00_fe_in_y) + ")*, lower than the regional average (" + strofreal(round(sp_dyn_le00_fe_in_reg,1)) + " years) and similar to the income group average (" + strofreal(round(sp_dyn_le00_fe_in_inc,1)) + " years). ", ///
	""))))))))) if sp_dyn_le00_fe_in!=.
	replace sp_dyn_le00_fe_in_text = "Internationally comparable data on female life expectancy at birth are not available for " + wbcountrynameb + "." if sp_dyn_le00_fe_in==.
	
	*------------------------*
	*Life expectancy, male
	*------------------------*
	gen sp_dyn_le00_ma_in_text = ///
	cond(round(sp_dyn_le00_ma_in)<round(sp_dyn_le00_ma_in_reg) & round(sp_dyn_le00_ma_in)<round(sp_dyn_le00_ma_in_inc), /// 
	"Male life expectancy at birth is **" + strofreal(round(sp_dyn_le00_ma_in,1)) + " years** *(" + strofreal(sp_dyn_le00_ma_in_y) + ")*, lower than both the regional (" + strofreal(round(sp_dyn_le00_ma_in_reg,1)) + " years) and income group (" + strofreal(round(sp_dyn_le00_ma_in_inc,1)) + " years) averages. ", ///
	cond(round(sp_dyn_le00_ma_in)>round(sp_dyn_le00_ma_in_reg) & round(sp_dyn_le00_ma_in)>round(sp_dyn_le00_ma_in_inc), ///
	"Male life expectancy at birth is **" + strofreal(round(sp_dyn_le00_ma_in,1)) + " years** *(" + strofreal(sp_dyn_le00_ma_in_y) + ")*, higher than both the regional (" + strofreal(round(sp_dyn_le00_ma_in_reg,1)) + " years) and income group (" + strofreal(round(sp_dyn_le00_ma_in_inc,1)) + " years) averages. ", ///
	cond(round(sp_dyn_le00_ma_in)>round(sp_dyn_le00_ma_in_reg) & round(sp_dyn_le00_ma_in)<round(sp_dyn_le00_ma_in_inc), ///
	"Male life expectancy at birth is **" + strofreal(round(sp_dyn_le00_ma_in,1)) + " years** *(" + strofreal(sp_dyn_le00_ma_in_y) + ")*, higher than the regional average (" + strofreal(round(sp_dyn_le00_ma_in_reg,1)) + " years) and lower than the income group average (" + strofreal(round(sp_dyn_le00_ma_in_inc,1)) + " years). ", ///
	cond(round(sp_dyn_le00_ma_in)<round(sp_dyn_le00_ma_in_reg) & round(sp_dyn_le00_ma_in)>round(sp_dyn_le00_ma_in_inc), ///
	"Male life expectancy at birth is **" + strofreal(round(sp_dyn_le00_ma_in,1)) + " years** *(" + strofreal(sp_dyn_le00_ma_in_y) + ")*, lower than the regional average (" + strofreal(round(sp_dyn_le00_ma_in_reg,1)) + " years) and higher than the income group average (" + strofreal(round(sp_dyn_le00_ma_in_inc,1)) + " years). ", ///
	cond(round(sp_dyn_le00_ma_in,1)==round(sp_dyn_le00_ma_in_reg,1) & round(sp_dyn_le00_ma_in,1)==round(sp_dyn_le00_ma_in_inc,1), ///
	"Male life expectancy at birth is **" + strofreal(round(sp_dyn_le00_ma_in,1)) + " years** *(" + strofreal(sp_dyn_le00_ma_in_y) + ")*, similar to both the regional (" + strofreal(round(sp_dyn_le00_ma_in_reg,1)) + " years) and income group (" + strofreal(round(sp_dyn_le00_ma_in_inc,1)) + " years) averages. ", ///
	cond(round(sp_dyn_le00_ma_in,1)==round(sp_dyn_le00_ma_in_reg,1) & round(sp_dyn_le00_ma_in,1)>round(sp_dyn_le00_ma_in_inc,1), ///
	"Male life expectancy at birth is **" + strofreal(round(sp_dyn_le00_ma_in,1)) + " years** *(" + strofreal(sp_dyn_le00_ma_in_y) + ")*, similar to the regional average (" + strofreal(round(sp_dyn_le00_ma_in_reg,1)) + " years) and higher than the income group average (" + strofreal(round(sp_dyn_le00_ma_in_inc,1)) + " years). ", ///
	cond(round(sp_dyn_le00_ma_in,1)==round(sp_dyn_le00_ma_in_reg,1) & round(sp_dyn_le00_ma_in,1)<round(sp_dyn_le00_ma_in_inc,1), ///
	"Male life expectancy at birth is **" + strofreal(round(sp_dyn_le00_ma_in,1)) + " years** *(" + strofreal(sp_dyn_le00_ma_in_y) + ")*, similar to the regional average (" + strofreal(round(sp_dyn_le00_ma_in_reg,1)) + " years) and lower than the income group average (" + strofreal(round(sp_dyn_le00_ma_in_inc,1)) + " years). ", ///
	cond(round(sp_dyn_le00_ma_in,1)>round(sp_dyn_le00_ma_in_reg,1) & round(sp_dyn_le00_ma_in,1)==round(sp_dyn_le00_ma_in_inc,1), ///
	"Male life expectancy at birth is **" + strofreal(round(sp_dyn_le00_ma_in,1)) + " years** *(" + strofreal(sp_dyn_le00_ma_in_y) + ")*, higher than the regional average (" + strofreal(round(sp_dyn_le00_ma_in_reg,1)) + " years) and similar to the income group average (" + strofreal(round(sp_dyn_le00_ma_in_inc,1)) + " years). ", ///
	cond(round(sp_dyn_le00_ma_in,1)<round(sp_dyn_le00_ma_in_reg,1) & round(sp_dyn_le00_ma_in,1)==round(sp_dyn_le00_ma_in_inc,1), ///
	"Male life expectancy at birth is **" + strofreal(round(sp_dyn_le00_ma_in,1)) + " years** *(" + strofreal(sp_dyn_le00_ma_in_y) + ")*, lower than the regional average (" + strofreal(round(sp_dyn_le00_ma_in_reg,1)) + " years) and similar to the income group average (" + strofreal(round(sp_dyn_le00_ma_in_inc,1)) + " years). ", ///
	""))))))))) if sp_dyn_le00_ma_in!=.
	replace sp_dyn_le00_ma_in_text = "Internationally comparable data on male life expectancy at birth are not available for " + wbcountrynameb + "." if sp_dyn_le00_ma_in==.
	...
	*-----------------Round values in hci variables for tables-----------------* 
	...
	foreach var in hci_m_2020 hci_f_2020 hci_mf_2020 psurv_m_2020 psurv_f_2020 psurv_mf_2020  asr_m_2020 asr_f_2020 asr_mf_2020 nostu_m_2020 nostu_f_2020 nostu_mf_2020 eyrs_m_2020 eyrs_f_2020 eyrs_mf_2020 qeyrs_m_2020 qeyrs_f_2020 qeyrs_mf_2020 test_m_2020 test_f_2020 test_mf_2020 {
	drop `var'_t
	}	
	
	gen hci_mf_2020_table = hci_mf_2020/100
	
	foreach var in nostu_mf_2020 asr_mf_2020 psurv_mf_2020{
	replace `var' = `var'/100
	}

	foreach var in hci_m_2020 hci_f_2020 hci_mf_2020_table hci_mf_2020 psurv_m_2020 psurv_f_2020 psurv_mf_2020  asr_m_2020 asr_f_2020 asr_mf_2020 nostu_m_2020 nostu_f_2020 nostu_mf_2020{
	gen `var'_t = strofreal(`var',"%04.2f")
	}

	foreach var in eyrs_m_2020 eyrs_f_2020 eyrs_mf_2020 qeyrs_m_2020 qeyrs_f_2020 qeyrs_mf_2020{
	gen `var'_t = strofreal(`var',"%4.1f")
	}
	
	foreach var in test_m_2020 test_f_2020 test_mf_2020{
	...
	*---------------------------------Save-------------------------------------*	
	...
	keep wb* *text  *text_1 *text_2 *text_3 hci_mf_lower_2020 hci_mf_upper_2020 hci_m_2010 hci_f_2010 hci_mf_2010 hci_m_2018 hci_f_2018 hci_mf_2018 hci_m_2020 hci_f_2020 hci_mf_2020 psurv_m_2010 psurv_f_2010 psurv_mf_2010 psurv_m_2018 psurv_f_2018 psurv_mf_2018 psurv_m_2020 psurv_f_2020 psurv_mf_2020 qeyrs_m_2010 qeyrs_f_2010 qeyrs_mf_2010 qeyrs_m_2018 qeyrs_f_2018 qeyrs_mf_2018 qeyrs_m_2020 qeyrs_f_2020 qeyrs_mf_2020 eyrs_m_2010 eyrs_f_2010 eyrs_mf_2010 eyrs_m_2018 eyrs_f_2018 eyrs_mf_2018 eyrs_m_2020 eyrs_f_2020 eyrs_mf_2020 test_m_2010 test_f_2010 test_mf_2010 test_m_2018 test_f_2018 test_mf_2018 test_m_2020 test_f_2020 test_mf_2020 asr_m_2010 asr_f_2010 asr_mf_2010 asr_m_2018 asr_f_2018 asr_mf_2018 asr_m_2020 asr_f_2020 asr_mf_2020 nostu_m_2010 nostu_f_2010 nostu_mf_2010 nostu_m_2018 nostu_f_2018 nostu_mf_2018 nostu_m_2020 nostu_f_2020 nostu_mf_2020 hci_m_2020_t hci_f_2020_t hci_mf_2020_t psurv_m_2020_t psurv_f_2020_t psurv_mf_2020_t asr_m_2020_t asr_f_2020_t asr_mf_2020_t nostu_m_2020_t nostu_f_2020_t nostu_mf_2020_t eyrs_m_2020_t eyrs_f_2020_t eyrs_mf_2020_t qeyrs_m_2020_t qeyrs_f_2020_t qeyrs_mf_2020_t test_m_2020_t test_f_2020_t test_mf_2020_t
	
	
	*merge 1:1 wbcountryname using "$input\text_HCI2020", nogen keep(1 3)		
	
	destring hci_mf_2020_t, replace
	replace hci_mf_2020_t = hci_mf_2020_t/100
	
	gen hci_mf_2020_t2 = strofreal(hci_mf_2020_t,"%04.2f")
	drop hci_mf_2020_t 
	rename hci_mf_2020_t2 hci_mf_2020_t
	br hci_mf_2020_t	
	
	
	save "$input\text", replace
	
	*---------------------------------Ordering---------------------------------*
	
	use "$input\text", clear
	keep wbcode unicef_neomort_text unicef_mealfreq_text vacbcg_text uisger02_text uisger02f_text uisger02m_text uisger01_text lastnm_mmrt_text_1 unicef_care_text lastnm_birth_reg_text_1 unicef_breastf_text unicef_diarrhoea_text uiscr1_text uiscr1f_text uiscr1m_text lastnm_sec_ger_text_1 se_lpv_prim_text se_lpv_prim_fe_text se_lpv_prim_ma_text vachepbb_text uiscr2_text eip_neet_mf_y_text eip_neet_f_y_text eip_neet_m_y_text lastnm_afr_text_1 lastnm_ter_ger_text une_2eap_mf_y_text une_2eap_f_y_text une_2eap_m_y_text eap_2wap_f_a_text eap_2wap_m_a_text sp_dyn_le00_in_text sp_dyn_le00_fe_in_text sp_dyn_le00_ma_in_text lastnm_probdeath_ncd_text_1
	...
	*----------------------------Position variable-----------------------------*
	...
	/**** Una vez que estén los locals nuevos, generar estas nuevas variables (ver cómo se hacía antes) ****/
{	
	gen pos = ""
...
replace pos = "b1" if wbcode=="AFG" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="AFG" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="AGO" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="AGO" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="ALB" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="ALB" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="ARE" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="ARE" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="ARG" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="ARG" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="ARM" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="ARM" & name=="eap_2wap_m_a"
replace pos = "b3" if wbcode=="ARM" & name=="sp_dyn_le00_in"
replace pos = "l1" if wbcode=="ATG" & name=="unicef_neomort"
replace pos = "l2" if wbcode=="ATG" & name=="uisger02f"
replace pos = "l3" if wbcode=="ATG" & name=="uisger02m"
...
replace pos = "b2" if wbcode=="ATG" & name=="sp_dyn_le00_fe_in"
replace pos = "b3" if wbcode=="ATG" & name=="sp_dyn_le00_ma_in"
...
replace pos = "e2" if wbcode=="AUS" & name=="se_lpv_prim_fe"
replace pos = "e3" if wbcode=="AUS" & name=="se_lpv_prim_ma"
...
replace pos = "b1" if wbcode=="AUS" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="AUS" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="AUT" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="AUT" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="AZE" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="AZE" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="BDI" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="BDI" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="BEL" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="BEL" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="BEN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="BEN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="BFA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="BFA" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="BGD" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="BGD" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="BGR" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="BGR" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="BHR" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="BHR" & name=="eap_2wap_m_a"
...
replace pos = "e2" if wbcode=="BIH" & name=="uiscr1f"
replace pos = "e3" if wbcode=="BIH" & name=="uiscr1m"
...
replace pos = "b1" if wbcode=="BIH" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="BIH" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="BLR" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="BLR" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="BRA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="BRA" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="BRN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="BRN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="BTN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="BTN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="BWA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="BWA" & name=="eap_2wap_m_a"
...
replace pos = "h2" if wbcode=="CAF" & name=="une_2eap_f_y"
replace pos = "h3" if wbcode=="CAF" & name=="une_2eap_m_y"
replace pos = "b1" if wbcode=="CAF" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="CAF" & name=="eap_2wap_m_a"
...
replace pos = "e2" if wbcode=="CAN" & name=="se_lpv_prim_fe"
replace pos = "e3" if wbcode=="CAN" & name=="se_lpv_prim_ma"
...
replace pos = "b1" if wbcode=="CAN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="CAN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="CHE" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="CHE" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="CHL" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="CHL" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="CHN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="CHN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="CIV" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="CIV" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="CMR" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="CMR" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="COD" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="COD" & name=="eap_2wap_m_a"
...
replace pos = "e1" if wbcode=="COG" & name=="se_lpv_prim_fe"
replace pos = "e2" if wbcode=="COG" & name=="se_lpv_prim_ma"
...
replace pos = "b1" if wbcode=="COG" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="COG" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="COL" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="COL" & name=="eap_2wap_m_a"
...
replace pos = "h2" if wbcode=="COM" & name=="une_2eap_f_y"
replace pos = "h3" if wbcode=="COM" & name=="une_2eap_m_y"
replace pos = "b1" if wbcode=="COM" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="COM" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="CRI" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="CRI" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="CUB" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="CUB" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="CYP" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="CYP" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="CZE" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="CZE" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="DEU" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="DEU" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="DMA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="DMA" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="DNK" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="DNK" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="DOM" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="DOM" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="DZA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="DZA" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="ECU" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="ECU" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="EGY" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="EGY" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="ESP" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="ESP" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="EST" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="EST" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="ETH" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="ETH" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="FIN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="FIN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="FJI" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="FJI" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="FRA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="FRA" & name=="eap_2wap_m_a"
...
replace pos = "b2" if wbcode=="FSM" & name=="sp_dyn_le00_fe_in"
replace pos = "b3" if wbcode=="FSM" & name=="sp_dyn_le00_ma_in"
...
replace pos = "b1" if wbcode=="GAB" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="GAB" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="GBR" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="GBR" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="GEO" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="GEO" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="GHA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="GHA" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="GIN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="GIN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="GMB" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="GMB" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="GRC" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="GRC" & name=="eap_2wap_m_a"
replace pos = "b3" if wbcode=="GRC" & name=="sp_dyn_le00_in"
replace pos = "l1" if wbcode=="GRD" & name=="unicef_neomort"
replace pos = "l2" if wbcode=="GRD" & name=="uisger02f"
replace pos = "l3" if wbcode=="GRD" & name=="uisger02m"
...
replace pos = "b2" if wbcode=="GRD" & name=="sp_dyn_le00_fe_in"
replace pos = "b3" if wbcode=="GRD" & name=="sp_dyn_le00_ma_in"
...
replace pos = "b1" if wbcode=="GTM" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="GTM" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="GUY" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="GUY" & name=="eap_2wap_m_a"
replace pos = "b3" if wbcode=="GUY" & name=="sp_dyn_le00_in"
replace pos = "l1" if wbcode=="HKG" & name=="uisger02f"
replace pos = "l2" if wbcode=="HKG" & name=="uisger02m"
...
replace pos = "b1" if wbcode=="HKG" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="HKG" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="HND" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="HND" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="HRV" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="HRV" & name=="eap_2wap_m_a"
...
replace pos = "h2" if wbcode=="HTI" & name=="une_2eap_f_y"
replace pos = "h3" if wbcode=="HTI" & name=="une_2eap_m_y"
replace pos = "b1" if wbcode=="HTI" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="HTI" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="HUN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="HUN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="IDN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="IDN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="IND" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="IND" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="IRL" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="IRL" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="IRN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="IRN" & name=="eap_2wap_m_a"
...
replace pos = "h2" if wbcode=="IRQ" & name=="une_2eap_f_y"
replace pos = "h3" if wbcode=="IRQ" & name=="une_2eap_m_y"
replace pos = "b1" if wbcode=="IRQ" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="IRQ" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="ISL" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="ISL" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="ISR" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="ISR" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="ITA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="ITA" & name=="eap_2wap_m_a"
...
replace pos = "e2" if wbcode=="JAM" & name=="uiscr1f"
replace pos = "e3" if wbcode=="JAM" & name=="uiscr1m"
...
replace pos = "b1" if wbcode=="JAM" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="JAM" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="JOR" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="JOR" & name=="eap_2wap_m_a"
...
replace pos = "e1" if wbcode=="JPN" & name=="se_lpv_prim_fe"
replace pos = "e2" if wbcode=="JPN" & name=="se_lpv_prim_ma"
replace pos = "e3" if wbcode=="JPN" & name=="uiscr1"
replace pos = "h1" if wbcode=="JPN" & name=="lastnm_afr"
replace pos = "h2" if wbcode=="JPN" & name=="une_2eap_f_y"
replace pos = "h3" if wbcode=="JPN" & name=="une_2eap_m_y"
replace pos = "b1" if wbcode=="JPN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="JPN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="KAZ" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="KAZ" & name=="eap_2wap_m_a"
...
replace pos = "e2" if wbcode=="KEN" & name=="uiscr1f"
replace pos = "e3" if wbcode=="KEN" & name=="uiscr1m"
...
replace pos = "b1" if wbcode=="KEN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="KEN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="KGZ" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="KGZ" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="KHM" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="KHM" & name=="eap_2wap_m_a"
...
replace pos = "h2" if wbcode=="KIR" & name=="eip_neet_f_y"
replace pos = "h3" if wbcode=="KIR" & name=="eip_neet_m_y"
replace pos = "b1" if wbcode=="KIR" & name=="lastnm_probdeath_ncd"
replace pos = "b2" if wbcode=="KIR" & name=="sp_dyn_le00_fe_in"
replace pos = "b3" if wbcode=="KIR" & name=="sp_dyn_le00_ma_in"
...
replace pos = "b1" if wbcode=="KNA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="KNA" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="KOR" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="KOR" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="KWT" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="KWT" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="LAO" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="LAO" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="LBN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="LBN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="LBR" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="LBR" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="LCA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="LCA" & name=="eap_2wap_m_a"
replace pos = "b3" if wbcode=="LCA" & name=="sp_dyn_le00_in"
replace pos = "l1" if wbcode=="LIE" & name=="lastnm_birth_reg"
replace pos = "l2" if wbcode=="LIE" & name=="uisger02f"
replace pos = "l3" if wbcode=="LIE" & name=="uisger02m"
...
replace pos = "b1" if wbcode=="LIE" & name=="sp_dyn_le00_fe_in"
replace pos = "b2" if wbcode=="LIE" & name=="sp_dyn_le00_ma_in"
replace pos = "b3" if wbcode=="LIE" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="LKA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="LKA" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="LSO" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="LSO" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="LTU" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="LTU" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="LUX" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="LUX" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="LVA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="LVA" & name=="eap_2wap_m_a"
replace pos = "b3" if wbcode=="LVA" & name=="sp_dyn_le00_in"
replace pos = "l1" if wbcode=="MAC" & name=="uisger02f"
replace pos = "l2" if wbcode=="MAC" & name=="uisger02m"
...
replace pos = "b1" if wbcode=="MAC" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="MAC" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="MAR" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="MAR" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="MDA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="MDA" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="MDG" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="MDG" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="MEX" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="MEX" & name=="eap_2wap_m_a"
...
replace pos = "h2" if wbcode=="MHL" & name=="eip_neet_f_y"
replace pos = "h3" if wbcode=="MHL" & name=="eip_neet_m_y"
replace pos = "b1" if wbcode=="MHL" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="MHL" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="MKD" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="MKD" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="MLI" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="MLI" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="MLT" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="MLT" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="MMR" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="MMR" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="MNE" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="MNE" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="MNG" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="MNG" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="MOZ" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="MOZ" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="MRT" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="MRT" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="MUS" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="MUS" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="MWI" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="MWI" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="MYS" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="MYS" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="NAM" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="NAM" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="NER" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="NER" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="NGA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="NGA" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="NIC" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="NIC" & name=="eap_2wap_m_a"
...
replace pos = "e2" if wbcode=="NLD" & name=="se_lpv_prim_fe"
replace pos = "e3" if wbcode=="NLD" & name=="se_lpv_prim_ma"
...
replace pos = "b1" if wbcode=="NLD" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="NLD" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="NOR" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="NOR" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="NPL" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="NPL" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="NRU" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="NRU" & name=="eap_2wap_m_a"
...
replace pos = "e2" if wbcode=="NZL" & name=="se_lpv_prim_fe"
replace pos = "e3" if wbcode=="NZL" & name=="se_lpv_prim_ma"
...
replace pos = "b1" if wbcode=="NZL" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="NZL" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="OMN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="OMN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="PAK" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="PAK" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="PAN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="PAN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="PER" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="PER" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="PHL" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="PHL" & name=="eap_2wap_m_a"
replace pos = "b3" if wbcode=="PHL" & name=="sp_dyn_le00_in"
replace pos = "l1" if wbcode=="PLW" & name=="unicef_neomort"
replace pos = "l2" if wbcode=="PLW" & name=="uisger02f"
replace pos = "l3" if wbcode=="PLW" & name=="uisger02m"
...
replace pos = "b1" if wbcode=="PLW" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="PLW" & name=="eap_2wap_m_a"
...
replace pos = "h2" if wbcode=="PNG" & name=="une_2eap_f_y"
replace pos = "h3" if wbcode=="PNG" & name=="une_2eap_m_y"
replace pos = "b1" if wbcode=="PNG" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="PNG" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="POL" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="POL" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="PRT" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="PRT" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="PRY" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="PRY" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="PSE" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="PSE" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="QAT" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="QAT" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="ROU" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="ROU" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="RUS" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="RUS" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="RWA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="RWA" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="SAU" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="SAU" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="SDN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="SDN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="SEN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="SEN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="SGP" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="SGP" & name=="eap_2wap_m_a"
...
replace pos = "h2" if wbcode=="SLB" & name=="une_2eap_f_y"
replace pos = "h3" if wbcode=="SLB" & name=="une_2eap_m_y"
replace pos = "b1" if wbcode=="SLB" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="SLB" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="SLE" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="SLE" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="SLV" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="SLV" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="SRB" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="SRB" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="SSD" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="SSD" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="SVK" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="SVK" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="SVN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="SVN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="SWE" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="SWE" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="SWZ" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="SWZ" & name=="eap_2wap_m_a"
...
replace pos = "b2" if wbcode=="SYC" & name=="sp_dyn_le00_fe_in"
replace pos = "b3" if wbcode=="SYC" & name=="sp_dyn_le00_ma_in"
...
replace pos = "b1" if wbcode=="SYR" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="SYR" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="TCD" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="TCD" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="TGO" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="TGO" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="THA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="THA" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="TJK" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="TJK" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="TLS" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="TLS" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="TON" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="TON" & name=="eap_2wap_m_a"
replace pos = "b3" if wbcode=="TON" & name=="sp_dyn_le00_in"
replace pos = "l1" if wbcode=="TTO" & name=="unicef_neomort"
replace pos = "l2" if wbcode=="TTO" & name=="uisger02f"
replace pos = "l3" if wbcode=="TTO" & name=="uisger02m"
replace pos = "e1" if wbcode=="TTO" & name=="se_lpv_prim_fe"
replace pos = "e2" if wbcode=="TTO" & name=="se_lpv_prim_ma"
replace pos = "e3" if wbcode=="TTO" & name=="uiscr1"
replace pos = "h1" if wbcode=="TTO" & name=="lastnm_afr"
replace pos = "h2" if wbcode=="TTO" & name=="une_2eap_f_y"
replace pos = "h3" if wbcode=="TTO" & name=="une_2eap_m_y"
replace pos = "b1" if wbcode=="TTO" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="TTO" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="TUN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="TUN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="TUR" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="TUR" & name=="eap_2wap_m_a"
...
replace pos = "h1" if wbcode=="TUV" & name=="eip_neet_f_y"
replace pos = "h2" if wbcode=="TUV" & name=="eip_neet_m_y"
replace pos = "h3" if wbcode=="TUV" & name=="lastnm_afr"
replace pos = "b1" if wbcode=="TUV" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="TUV" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="TZA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="TZA" & name=="eap_2wap_m_a"
...
replace pos = "e2" if wbcode=="UGA" & name=="uiscr1f"
replace pos = "e3" if wbcode=="UGA" & name=="uiscr1m"
...
replace pos = "b1" if wbcode=="UGA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="UGA" & name=="eap_2wap_m_a"
...
replace pos = "h2" if wbcode=="UKR" & name=="une_2eap_f_y"
replace pos = "h3" if wbcode=="UKR" & name=="une_2eap_m_y"
replace pos = "b1" if wbcode=="UKR" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="UKR" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="URY" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="URY" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="USA" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="USA" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="UZB" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="UZB" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="VCT" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="VCT" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="VEN" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="VEN" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="VNM" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="VNM" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="VUT" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="VUT" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="WSM" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="WSM" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="XKX" & name=="sp_dyn_le00_fe_in"
replace pos = "b2" if wbcode=="XKX" & name=="sp_dyn_le00_ma_in"
replace pos = "b3" if wbcode=="XKX" & name=="eap_2wap_m_a"
...
replace pos = "h2" if wbcode=="YEM" & name=="une_2eap_f_y"
replace pos = "h3" if wbcode=="YEM" & name=="une_2eap_m_y"
replace pos = "b1" if wbcode=="YEM" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="YEM" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="ZAF" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="ZAF" & name=="eap_2wap_m_a"
...
replace pos = "b1" if wbcode=="ZMB" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="ZMB" & name=="eap_2wap_m_a"
...
replace pos = "e2" if wbcode=="ZWE" & name=="uiscr1f"
replace pos = "e3" if wbcode=="ZWE" & name=="uiscr1m"
...
replace pos = "b1" if wbcode=="ZWE" & name=="eap_2wap_f_a"
replace pos = "b2" if wbcode=="ZWE" & name=="eap_2wap_m_a"
...
/*	
	...
	replace pos = "b2" if wbcode=="AGO" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="AGO" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="AGO" & name=="uiscr1"
	replace pos = "e2" if wbcode=="AGO" & name=="lastnm_sec_ger"
	replace pos = "e3" if wbcode=="AGO" & name=="uiscr2"
	replace pos = "h1" if wbcode=="AGO" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="AGO" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="AGO" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="AGO" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="ARE" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="ARE" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="ARE" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="ARE" & name=="se_lpv_prim"
	replace pos = "e3" if wbcode=="ARE" & name=="vachepbb"
	replace pos = "h1" if wbcode=="ARE" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="ARE" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="ARE" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="ARE" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="AUT" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="AUT" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="AUT" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="AUT" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="AUT" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="AUT" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="AUT" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="AUT" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="AUT" & name=="unicef_neomort"
	...
	replace pos = "b3" if wbcode=="BEL" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="BEL" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="BEL" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="BEL" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="BEL" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="BEL" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="BEL" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="BEL" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="BGD" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="BGD" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="BGD" & name=="uiscr1"
	replace pos = "e2" if wbcode=="BGD" & name=="lastnm_sec_ger"
	replace pos = "e3" if wbcode=="BGD" & name=="se_lpv_prim"
	replace pos = "h1" if wbcode=="BGD" & name=="eip_neet_mf_y"
	replace pos = "h2" if wbcode=="BGD" & name=="lastnm_afr"
	replace pos = "h3" if wbcode=="BGD" & name=="lastnm_ter_ger"
	replace pos = "l1" if wbcode=="BGD" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="BGR" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="BGR" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="BGR" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="BGR" & name=="se_lpv_prim"
	replace pos = "e3" if wbcode=="BGR" & name=="vachepbb"
	replace pos = "h1" if wbcode=="BGR" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="BGR" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="BGR" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="BGR" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="BHR" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="BHR" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="BHR" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="BHR" & name=="se_lpv_prim"
	replace pos = "e3" if wbcode=="BHR" & name=="vachepbb"
	replace pos = "h1" if wbcode=="BHR" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="BHR" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="BHR" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="BHR" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="BRA" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="BRA" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="BRA" & name=="uiscr1"
	replace pos = "e2" if wbcode=="BRA" & name=="lastnm_sec_ger"
	replace pos = "e3" if wbcode=="BRA" & name=="se_lpv_prim"
	replace pos = "h1" if wbcode=="BRA" & name=="eip_neet_mf_y"
	replace pos = "h2" if wbcode=="BRA" & name=="lastnm_afr"
	replace pos = "h3" if wbcode=="BRA" & name=="lastnm_ter_ger"
	replace pos = "l1" if wbcode=="BRA" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="CHN" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="CHN" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="CHN" & name=="uiscr1"
	replace pos = "e2" if wbcode=="CHN" & name=="se_lpv_prim"
	replace pos = "e3" if wbcode=="CHN" & name=="uiscr2"
	replace pos = "h1" if wbcode=="CHN" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="CHN" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="CHN" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="CHN" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="COG" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="COG" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="COG" & name=="uiscr1"
	replace pos = "e2" if wbcode=="COG" & name=="se_lpv_prim"
	replace pos = "e3" if wbcode=="COG" & name=="uiscr2"
	replace pos = "h1" if wbcode=="COG" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="COG" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="COG" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="COG" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="CYP" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="CYP" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="CYP" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="CYP" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="CYP" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="CYP" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="CYP" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="CYP" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="CYP" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="CZE" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="CZE" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="CZE" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="CZE" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="CZE" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="CZE" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="CZE" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="CZE" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="CZE" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="DEU" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="DEU" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="DEU" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="DEU" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="DEU" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="DEU" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="DEU" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="DEU" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="DEU" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="DNK" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="DNK" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="DNK" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="DNK" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="DNK" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="DNK" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="DNK" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="DNK" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="DNK" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="ESP" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="ESP" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="ESP" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="ESP" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="ESP" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="ESP" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="ESP" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="ESP" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="ESP" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="FIN" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="FIN" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="FIN" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="FIN" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="FIN" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="FIN" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="FIN" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="FIN" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="FIN" & name=="unicef_neomort"
	...
	replace pos = "b3" if wbcode=="FRA" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="FRA" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="FRA" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="FRA" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="FRA" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="FRA" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="FRA" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="FRA" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="GAB" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="GAB" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="GAB" & name=="uiscr2"
	replace pos = "e2" if wbcode=="GAB" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="GAB" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="GAB" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="GAB" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="GAB" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="GAB" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="GBR" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="GBR" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="GBR" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="GBR" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="GBR" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="GBR" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="GBR" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="GBR" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="GBR" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="GUY" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="GUY" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="GUY" & name=="uiscr1"
	replace pos = "e2" if wbcode=="GUY" & name=="uiscr2"
	replace pos = "e3" if wbcode=="GUY" & name=="vachepbb"
	replace pos = "h1" if wbcode=="GUY" & name=="eip_neet_mf_y"
	replace pos = "h2" if wbcode=="GUY" & name=="lastnm_afr"
	replace pos = "h3" if wbcode=="GUY" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="GUY" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="HND" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="HND" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="HND" & name=="uiscr1"
	replace pos = "e2" if wbcode=="HND" & name=="se_lpv_prim"
	replace pos = "e3" if wbcode=="HND" & name=="uiscr2"
	replace pos = "h1" if wbcode=="HND" & name=="eip_neet_mf_y"
	replace pos = "h2" if wbcode=="HND" & name=="lastnm_afr"
	replace pos = "h3" if wbcode=="HND" & name=="lastnm_ter_ger"
	replace pos = "l1" if wbcode=="HND" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="HRV" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="HRV" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="HRV" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="HRV" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="HRV" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="HRV" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="HRV" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="HRV" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="HRV" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="HTI" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="HTI" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="HTI" & name=="uiscr2"
	replace pos = "e2" if wbcode=="HTI" & name=="uiscr1f"
	replace pos = "e3" if wbcode=="HTI" & name=="uiscr1m"
	replace pos = "h1" if wbcode=="HTI" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="HTI" & name=="une_2eap_f_y"
	replace pos = "h3" if wbcode=="HTI" & name=="une_2eap_m_y"
	replace pos = "l1" if wbcode=="HTI" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="HUN" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="HUN" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="HUN" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="HUN" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="HUN" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="HUN" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="HUN" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="HUN" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="HUN" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="IRL" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="IRL" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="IRL" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="IRL" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="IRL" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="IRL" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="IRL" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="IRL" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="IRL" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="IRQ" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="IRQ" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="IRQ" & name=="uiscr1"
	replace pos = "e2" if wbcode=="IRQ" & name=="uiscr2"
	replace pos = "e3" if wbcode=="IRQ" & name=="vachepbb"
	replace pos = "h1" if wbcode=="IRQ" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="IRQ" & name=="une_2eap_f_y"
	replace pos = "h3" if wbcode=="IRQ" & name=="une_2eap_m_y"
	replace pos = "l1" if wbcode=="IRQ" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="ISR" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="ISR" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="ISR" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="ISR" & name=="se_lpv_prim"
	replace pos = "e3" if wbcode=="ISR" & name=="vachepbb"
	replace pos = "h1" if wbcode=="ISR" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="ISR" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="ISR" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="ISR" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="ITA" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="ITA" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="ITA" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="ITA" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="ITA" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="ITA" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="ITA" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="ITA" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="ITA" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="KOR" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="KOR" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="KOR" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="KOR" & name=="se_lpv_prim"
	replace pos = "e3" if wbcode=="KOR" & name=="vachepbb"
	replace pos = "h1" if wbcode=="KOR" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="KOR" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="KOR" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="KOR" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="KWT" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="KWT" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="KWT" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="KWT" & name=="se_lpv_prim"
	replace pos = "e3" if wbcode=="KWT" & name=="vachepbb"
	replace pos = "h1" if wbcode=="KWT" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="KWT" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="KWT" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="KWT" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="LTU" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="LTU" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="LTU" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="LTU" & name=="se_lpv_prim"
	replace pos = "e3" if wbcode=="LTU" & name=="vachepbb"
	replace pos = "h1" if wbcode=="LTU" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="LTU" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="LTU" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="LTU" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="LVA" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="LVA" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="LVA" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="LVA" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="LVA" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="LVA" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="LVA" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="LVA" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="LVA" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="NGA" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="NGA" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="NGA" & name=="uiscr1"
	replace pos = "e2" if wbcode=="NGA" & name=="lastnm_sec_ger"
	replace pos = "e3" if wbcode=="NGA" & name=="uiscr2"
	replace pos = "h1" if wbcode=="NGA" & name=="eip_neet_mf_y"
	replace pos = "h2" if wbcode=="NGA" & name=="lastnm_afr"
	replace pos = "h3" if wbcode=="NGA" & name=="lastnm_ter_ger"
	replace pos = "l1" if wbcode=="NGA" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="NIC" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="NIC" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="NIC" & name=="uiscr1"
	replace pos = "e2" if wbcode=="NIC" & name=="se_lpv_prim"
	replace pos = "e3" if wbcode=="NIC" & name=="uiscr2"
	replace pos = "h1" if wbcode=="NIC" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="NIC" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="NIC" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="NIC" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="NOR" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="NOR" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="NOR" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="NOR" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="NOR" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="NOR" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="NOR" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="NOR" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="NOR" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="OMN" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="OMN" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="OMN" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="OMN" & name=="se_lpv_prim"
	replace pos = "e3" if wbcode=="OMN" & name=="vachepbb"
	replace pos = "h1" if wbcode=="OMN" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="OMN" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="OMN" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="OMN" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="POL" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="POL" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="POL" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="POL" & name=="se_lpv_prim"
	replace pos = "e3" if wbcode=="POL" & name=="vachepbb"
	replace pos = "h1" if wbcode=="POL" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="POL" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="POL" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="POL" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="PRT" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="PRT" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="PRT" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="PRT" & name=="se_lpv_prim"
	replace pos = "e3" if wbcode=="PRT" & name=="vachepbb"
	replace pos = "h1" if wbcode=="PRT" & name=="eip_neet_mf_y"
	replace pos = "h2" if wbcode=="PRT" & name=="lastnm_afr"
	replace pos = "h3" if wbcode=="PRT" & name=="lastnm_ter_ger"
	replace pos = "l1" if wbcode=="PRT" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="QAT" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="QAT" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="QAT" & name=="vachepbb"
	replace pos = "e2" if wbcode=="QAT" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="QAT" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="QAT" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="QAT" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="QAT" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="QAT" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="SAU" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="SAU" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="SAU" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="SAU" & name=="se_lpv_prim"
	replace pos = "e3" if wbcode=="SAU" & name=="vachepbb"
	replace pos = "h1" if wbcode=="SAU" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="SAU" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="SAU" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="SAU" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="SGP" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="SGP" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="SGP" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="SGP" & name=="se_lpv_prim"
	replace pos = "e3" if wbcode=="SGP" & name=="vachepbb"
	replace pos = "h1" if wbcode=="SGP" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="SGP" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="SGP" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="SGP" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="SLV" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="SLV" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="SLV" & name=="uiscr1"
	replace pos = "e2" if wbcode=="SLV" & name=="uiscr2"
	replace pos = "e3" if wbcode=="SLV" & name=="vachepbb"
	replace pos = "h1" if wbcode=="SLV" & name=="eip_neet_mf_y"
	replace pos = "h2" if wbcode=="SLV" & name=="lastnm_afr"
	replace pos = "h3" if wbcode=="SLV" & name=="lastnm_ter_ger"
	replace pos = "l1" if wbcode=="SLV" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="SSD" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="SSD" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="SSD" & name=="uiscr1"
	replace pos = "e2" if wbcode=="SSD" & name=="lastnm_sec_ger"
	replace pos = "e3" if wbcode=="SSD" & name=="uiscr2"
	replace pos = "h1" if wbcode=="SSD" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="SSD" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="SSD" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="SSD" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="SVK" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="SVK" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="SVK" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="SVK" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="SVK" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="SVK" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="SVK" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="SVK" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="SVK" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="SVN" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="SVN" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="SVN" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="SVN" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="SVN" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="SVN" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="SVN" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="SVN" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="SVN" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="SWE" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="SWE" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="SWE" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="SWE" & name=="se_lpv_prim_fe"
	replace pos = "e3" if wbcode=="SWE" & name=="se_lpv_prim_ma"
	replace pos = "h1" if wbcode=="SWE" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="SWE" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="SWE" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="SWE" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="SYR" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="SYR" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="SYR" & name=="uiscr2"
	replace pos = "e2" if wbcode=="SYR" & name=="uiscr1f"
	replace pos = "e3" if wbcode=="SYR" & name=="uiscr1m"
	replace pos = "h1" if wbcode=="SYR" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="SYR" & name=="lastnm_ter_ger"
	replace pos = "h3" if wbcode=="SYR" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="SYR" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="TTO" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="TTO" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="TTO" & name=="uiscr1"
	replace pos = "e2" if wbcode=="TTO" & name=="se_lpv_prim"
	replace pos = "e3" if wbcode=="TTO" & name=="uiscr2"
	replace pos = "h1" if wbcode=="TTO" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="TTO" & name=="une_2eap_f_y"
	replace pos = "h3" if wbcode=="TTO" & name=="une_2eap_m_y"
	replace pos = "l1" if wbcode=="TTO" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="TUR" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="TUR" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="TUR" & name=="lastnm_sec_ger"
	replace pos = "e2" if wbcode=="TUR" & name=="se_lpv_prim"
	replace pos = "e3" if wbcode=="TUR" & name=="vachepbb"
	replace pos = "h1" if wbcode=="TUR" & name=="eip_neet_mf_y"
	replace pos = "h2" if wbcode=="TUR" & name=="lastnm_afr"
	replace pos = "h3" if wbcode=="TUR" & name=="lastnm_ter_ger"
	replace pos = "l1" if wbcode=="TUR" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="UKR" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="UKR" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="UKR" & name=="uiscr1"
	replace pos = "e2" if wbcode=="UKR" & name=="uiscr2"
	replace pos = "e3" if wbcode=="UKR" & name=="vachepbb"
	replace pos = "h1" if wbcode=="UKR" & name=="lastnm_afr"
	replace pos = "h2" if wbcode=="UKR" & name=="une_2eap_f_y"
	replace pos = "h3" if wbcode=="UKR" & name=="une_2eap_m_y"
	replace pos = "l1" if wbcode=="UKR" & name=="unicef_neomort"
	...
	replace pos = "b2" if wbcode=="ZMB" & name=="eap_2wap_m_a"
	replace pos = "b3" if wbcode=="ZMB" & name=="sp_dyn_le00_in"
	replace pos = "e1" if wbcode=="ZMB" & name=="uiscr2"
	replace pos = "e2" if wbcode=="ZMB" & name=="uiscr1f"
	replace pos = "e3" if wbcode=="ZMB" & name=="uiscr1m"
	replace pos = "h1" if wbcode=="ZMB" & name=="eip_neet_mf_y"
	replace pos = "h2" if wbcode=="ZMB" & name=="lastnm_afr"
	replace pos = "h3" if wbcode=="ZMB" & name=="une_2eap_mf_y"
	replace pos = "l1" if wbcode=="ZMB" & name=="unicef_neomort"
...
replace lab = "Female labour force participation (%)" if wbcode=="AFG" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="AFG" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="AGO" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="AGO" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="ALB" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="ALB" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="ARE" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="ARE" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="ARG" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="ARG" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="ARM" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="ARM" & name=="eap_2wap_m_a"
...
replace lab = "Female pre-primary school gross enrollment (%)" if wbcode=="ATG" & name=="uisger02f"
replace lab = "Male pre-primary school gross enrollment (%)" if wbcode=="ATG" & name=="uisger02m"
...
replace lab = "Female life expectancy at birth (years)" if wbcode=="ATG" & name=="sp_dyn_le00_fe_in"
replace lab = "Male life expectancy at birth (years)" if wbcode=="ATG" & name=="sp_dyn_le00_ma_in"
...
replace lab = "Female learning poverty (%)" if wbcode=="AUS" & name=="se_lpv_prim_fe"
replace lab = "Male learning poverty (%)" if wbcode=="AUS" & name=="se_lpv_prim_ma"
...
replace lab = "Female labour force participation (%)" if wbcode=="AUS" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="AUS" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="AUT" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="AUT" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="AZE" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="AZE" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="BDI" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="BDI" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="BEL" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="BEL" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="BEN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="BEN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="BFA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="BFA" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="BGD" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="BGD" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="BGR" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="BGR" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="BHR" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="BHR" & name=="eap_2wap_m_a"
...
replace lab = "Female primary school completion (%)" if wbcode=="BIH" & name=="uiscr1f"
replace lab = "Male primary school completion (%)" if wbcode=="BIH" & name=="uiscr1m"
...
replace lab = "Female labour force participation (%)" if wbcode=="BIH" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="BIH" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="BLR" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="BLR" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="BRA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="BRA" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="BRN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="BRN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="BTN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="BTN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="BWA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="BWA" & name=="eap_2wap_m_a"
...
replace lab = "Female youth unemployment (%)" if wbcode=="CAF" & name=="une_2eap_f_y"
replace lab = "Male youth unemployment (%)" if wbcode=="CAF" & name=="une_2eap_m_y"
replace lab = "Female labour force participation (%)" if wbcode=="CAF" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="CAF" & name=="eap_2wap_m_a"
...
replace lab = "Female learning poverty (%)" if wbcode=="CAN" & name=="se_lpv_prim_fe"
replace lab = "Male learning poverty (%)" if wbcode=="CAN" & name=="se_lpv_prim_ma"
...
replace lab = "Female labour force participation (%)" if wbcode=="CAN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="CAN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="CHE" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="CHE" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="CHL" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="CHL" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="CHN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="CHN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="CIV" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="CIV" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="CMR" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="CMR" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="COD" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="COD" & name=="eap_2wap_m_a"
...
replace lab = "Female learning poverty (%)" if wbcode=="COG" & name=="se_lpv_prim_fe"
replace lab = "Male learning poverty (%)" if wbcode=="COG" & name=="se_lpv_prim_ma"
...
replace lab = "Female labour force participation (%)" if wbcode=="COG" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="COG" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="COL" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="COL" & name=="eap_2wap_m_a"
...
replace lab = "Female youth unemployment (%)" if wbcode=="COM" & name=="une_2eap_f_y"
replace lab = "Male youth unemployment (%)" if wbcode=="COM" & name=="une_2eap_m_y"
replace lab = "Female labour force participation (%)" if wbcode=="COM" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="COM" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="CRI" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="CRI" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="CUB" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="CUB" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="CYP" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="CYP" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="CZE" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="CZE" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="DEU" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="DEU" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="DMA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="DMA" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="DNK" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="DNK" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="DOM" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="DOM" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="DZA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="DZA" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="ECU" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="ECU" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="EGY" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="EGY" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="ESP" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="ESP" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="EST" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="EST" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="ETH" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="ETH" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="FIN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="FIN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="FJI" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="FJI" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="FRA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="FRA" & name=="eap_2wap_m_a"
...
replace lab = "Female life expectancy at birth (years)" if wbcode=="FSM" & name=="sp_dyn_le00_fe_in"
replace lab = "Male life expectancy at birth (years)" if wbcode=="FSM" & name=="sp_dyn_le00_ma_in"
...
replace lab = "Female labour force participation (%)" if wbcode=="GAB" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="GAB" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="GBR" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="GBR" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="GEO" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="GEO" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="GHA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="GHA" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="GIN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="GIN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="GMB" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="GMB" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="GRC" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="GRC" & name=="eap_2wap_m_a"
...
replace lab = "Female pre-primary school gross enrollment (%)" if wbcode=="GRD" & name=="uisger02f"
replace lab = "Male pre-primary school gross enrollment (%)" if wbcode=="GRD" & name=="uisger02m"
...
replace lab = "Female life expectancy at birth (years)" if wbcode=="GRD" & name=="sp_dyn_le00_fe_in"
replace lab = "Male life expectancy at birth (years)" if wbcode=="GRD" & name=="sp_dyn_le00_ma_in"
...
replace lab = "Female labour force participation (%)" if wbcode=="GTM" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="GTM" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="GUY" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="GUY" & name=="eap_2wap_m_a"
replace lab = "Life expectancy at birth (years)" if wbcode=="GUY" & name=="sp_dyn_le00_in"
replace lab = "Female pre-primary school gross enrollment (%)" if wbcode=="HKG" & name=="uisger02f"
replace lab = "Male pre-primary school gross enrollment (%)" if wbcode=="HKG" & name=="uisger02m"
...
replace lab = "Female labour force participation (%)" if wbcode=="HKG" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="HKG" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="HND" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="HND" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="HRV" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="HRV" & name=="eap_2wap_m_a"
...
replace lab = "Female youth unemployment (%)" if wbcode=="HTI" & name=="une_2eap_f_y"
replace lab = "Male youth unemployment (%)" if wbcode=="HTI" & name=="une_2eap_m_y"
replace lab = "Female labour force participation (%)" if wbcode=="HTI" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="HTI" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="HUN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="HUN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="IDN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="IDN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="IND" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="IND" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="IRL" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="IRL" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="IRN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="IRN" & name=="eap_2wap_m_a"
...
replace lab = "Female youth unemployment (%)" if wbcode=="IRQ" & name=="une_2eap_f_y"
replace lab = "Male youth unemployment (%)" if wbcode=="IRQ" & name=="une_2eap_m_y"
replace lab = "Female labour force participation (%)" if wbcode=="IRQ" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="IRQ" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="ISL" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="ISL" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="ISR" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="ISR" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="ITA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="ITA" & name=="eap_2wap_m_a"
...
replace lab = "Female primary school completion (%)" if wbcode=="JAM" & name=="uiscr1f"
replace lab = "Male primary school completion (%)" if wbcode=="JAM" & name=="uiscr1m"
...
replace lab = "Female labour force participation (%)" if wbcode=="JAM" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="JAM" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="JOR" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="JOR" & name=="eap_2wap_m_a"
...
replace lab = "Female learning poverty (%)" if wbcode=="JPN" & name=="se_lpv_prim_fe"
replace lab = "Male learning poverty (%)" if wbcode=="JPN" & name=="se_lpv_prim_ma"
...
replace lab = "Female youth unemployment (%)" if wbcode=="JPN" & name=="une_2eap_f_y"
replace lab = "Male youth unemployment (%)" if wbcode=="JPN" & name=="une_2eap_m_y"
replace lab = "Female labour force participation (%)" if wbcode=="JPN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="JPN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="KAZ" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="KAZ" & name=="eap_2wap_m_a"
...
replace lab = "Female primary school completion (%)" if wbcode=="KEN" & name=="uiscr1f"
replace lab = "Male primary school completion (%)" if wbcode=="KEN" & name=="uiscr1m"
...
replace lab = "Female labour force participation (%)" if wbcode=="KEN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="KEN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="KGZ" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="KGZ" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="KHM" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="KHM" & name=="eap_2wap_m_a"
...
replace lab = "Female youth NEET (%)" if wbcode=="KIR" & name=="eip_neet_f_y"
replace lab = "Male youth NEET (%)" if wbcode=="KIR" & name=="eip_neet_m_y"
replace lab = "Probability of dying from NCDs (%)" if wbcode=="KIR" & name=="lastnm_probdeath_ncd"
replace lab = "Female life expectancy at birth (years)" if wbcode=="KIR" & name=="sp_dyn_le00_fe_in"
replace lab = "Male life expectancy at birth (years)" if wbcode=="KIR" & name=="sp_dyn_le00_ma_in"
...
replace lab = "Female labour force participation (%)" if wbcode=="KNA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="KNA" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="KOR" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="KOR" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="KWT" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="KWT" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="LAO" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="LAO" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="LBN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="LBN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="LBR" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="LBR" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="LCA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="LCA" & name=="eap_2wap_m_a"
...
replace lab = "Female pre-primary school gross enrollment (%)" if wbcode=="LIE" & name=="uisger02f"
replace lab = "Male pre-primary school gross enrollment (%)" if wbcode=="LIE" & name=="uisger02m"
...
replace lab = "Female life expectancy at birth (years)" if wbcode=="LIE" & name=="sp_dyn_le00_fe_in"
replace lab = "Male life expectancy at birth (years)" if wbcode=="LIE" & name=="sp_dyn_le00_ma_in"
replace lab = "Male labour force participation (%)" if wbcode=="LIE" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="LKA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="LKA" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="LSO" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="LSO" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="LTU" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="LTU" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="LUX" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="LUX" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="LVA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="LVA" & name=="eap_2wap_m_a"
replace lab = "Life expectancy at birth (years)" if wbcode=="LVA" & name=="sp_dyn_le00_in"
replace lab = "Female pre-primary school gross enrollment (%)" if wbcode=="MAC" & name=="uisger02f"
replace lab = "Male pre-primary school gross enrollment (%)" if wbcode=="MAC" & name=="uisger02m"
...
replace lab = "Female labour force participation (%)" if wbcode=="MAC" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="MAC" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="MAR" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="MAR" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="MDA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="MDA" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="MDG" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="MDG" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="MEX" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="MEX" & name=="eap_2wap_m_a"
...
replace lab = "Female youth NEET (%)" if wbcode=="MHL" & name=="eip_neet_f_y"
replace lab = "Male youth NEET (%)" if wbcode=="MHL" & name=="eip_neet_m_y"
replace lab = "Female labour force participation (%)" if wbcode=="MHL" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="MHL" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="MKD" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="MKD" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="MLI" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="MLI" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="MLT" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="MLT" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="MMR" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="MMR" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="MNE" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="MNE" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="MNG" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="MNG" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="MOZ" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="MOZ" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="MRT" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="MRT" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="MUS" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="MUS" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="MWI" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="MWI" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="MYS" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="MYS" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="NAM" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="NAM" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="NER" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="NER" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="NGA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="NGA" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="NIC" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="NIC" & name=="eap_2wap_m_a"
...
replace lab = "Female learning poverty (%)" if wbcode=="NLD" & name=="se_lpv_prim_fe"
replace lab = "Male learning poverty (%)" if wbcode=="NLD" & name=="se_lpv_prim_ma"
...
replace lab = "Female labour force participation (%)" if wbcode=="NLD" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="NLD" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="NOR" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="NOR" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="NPL" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="NPL" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="NRU" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="NRU" & name=="eap_2wap_m_a"
...
replace lab = "Female learning poverty (%)" if wbcode=="NZL" & name=="se_lpv_prim_fe"
replace lab = "Male learning poverty (%)" if wbcode=="NZL" & name=="se_lpv_prim_ma"
...
replace lab = "Female labour force participation (%)" if wbcode=="NZL" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="NZL" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="OMN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="OMN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="PAK" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="PAK" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="PAN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="PAN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="PER" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="PER" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="PHL" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="PHL" & name=="eap_2wap_m_a"
...
replace lab = "Female pre-primary school gross enrollment (%)" if wbcode=="PLW" & name=="uisger02f"
replace lab = "Male pre-primary school gross enrollment (%)" if wbcode=="PLW" & name=="uisger02m"
...
replace lab = "Female labour force participation (%)" if wbcode=="PLW" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="PLW" & name=="eap_2wap_m_a"
...
replace lab = "Female youth unemployment (%)" if wbcode=="PNG" & name=="une_2eap_f_y"
replace lab = "Male youth unemployment (%)" if wbcode=="PNG" & name=="une_2eap_m_y"
replace lab = "Female labour force participation (%)" if wbcode=="PNG" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="PNG" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="POL" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="POL" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="PRT" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="PRT" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="PRY" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="PRY" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="PSE" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="PSE" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="QAT" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="QAT" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="ROU" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="ROU" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="RUS" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="RUS" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="RWA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="RWA" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="SAU" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="SAU" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="SDN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="SDN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="SEN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="SEN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="SGP" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="SGP" & name=="eap_2wap_m_a"
...
replace lab = "Female youth unemployment (%)" if wbcode=="SLB" & name=="une_2eap_f_y"
replace lab = "Male youth unemployment (%)" if wbcode=="SLB" & name=="une_2eap_m_y"
replace lab = "Female labour force participation (%)" if wbcode=="SLB" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="SLB" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="SLE" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="SLE" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="SLV" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="SLV" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="SRB" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="SRB" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="SSD" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="SSD" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="SVK" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="SVK" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="SVN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="SVN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="SWE" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="SWE" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="SWZ" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="SWZ" & name=="eap_2wap_m_a"
...
replace lab = "Female life expectancy at birth (years)" if wbcode=="SYC" & name=="sp_dyn_le00_fe_in"
replace lab = "Male life expectancy at birth (years)" if wbcode=="SYC" & name=="sp_dyn_le00_ma_in"
...
replace lab = "Female labour force participation (%)" if wbcode=="SYR" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="SYR" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="TCD" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="TCD" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="TGO" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="TGO" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="THA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="THA" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="TJK" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="TJK" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="TLS" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="TLS" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="TON" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="TON" & name=="eap_2wap_m_a"
...
replace lab = "Female pre-primary school gross enrollment (%)" if wbcode=="TTO" & name=="uisger02f"
replace lab = "Male pre-primary school gross enrollment (%)" if wbcode=="TTO" & name=="uisger02m"
replace lab = "Female learning poverty (%)" if wbcode=="TTO" & name=="se_lpv_prim_fe"
replace lab = "Male learning poverty (%)" if wbcode=="TTO" & name=="se_lpv_prim_ma"
...
replace lab = "Female youth unemployment (%)" if wbcode=="TTO" & name=="une_2eap_f_y"
replace lab = "Male youth unemployment (%)" if wbcode=="TTO" & name=="une_2eap_m_y"
replace lab = "Female labour force participation (%)" if wbcode=="TTO" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="TTO" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="TUN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="TUN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="TUR" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="TUR" & name=="eap_2wap_m_a"
...
replace lab = "Female youth NEET (%)" if wbcode=="TUV" & name=="eip_neet_f_y"
replace lab = "Male youth NEET (%)" if wbcode=="TUV" & name=="eip_neet_m_y"
replace lab = "Adolescent fertility (births/1000 women)" if wbcode=="TUV" & name=="lastnm_afr"
replace lab = "Female labour force participation (%)" if wbcode=="TUV" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="TUV" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="TZA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="TZA" & name=="eap_2wap_m_a"
...
replace lab = "Female primary school completion (%)" if wbcode=="UGA" & name=="uiscr1f"
replace lab = "Male primary school completion (%)" if wbcode=="UGA" & name=="uiscr1m"
...
replace lab = "Female labour force participation (%)" if wbcode=="UGA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="UGA" & name=="eap_2wap_m_a"
...
replace lab = "Female youth unemployment (%)" if wbcode=="UKR" & name=="une_2eap_f_y"
replace lab = "Male youth unemployment (%)" if wbcode=="UKR" & name=="une_2eap_m_y"
replace lab = "Female labour force participation (%)" if wbcode=="UKR" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="UKR" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="URY" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="URY" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="USA" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="USA" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="UZB" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="UZB" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="VCT" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="VCT" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="VEN" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="VEN" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="VNM" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="VNM" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="VUT" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="VUT" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="WSM" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="WSM" & name=="eap_2wap_m_a"
...
replace lab = "Female life expectancy at birth (years)" if wbcode=="XKX" & name=="sp_dyn_le00_fe_in"
replace lab = "Male life expectancy at birth (years)" if wbcode=="XKX" & name=="sp_dyn_le00_ma_in"
replace lab = "Male labour force participation (%)" if wbcode=="XKX" & name=="eap_2wap_m_a"
...
replace lab = "Female youth unemployment (%)" if wbcode=="YEM" & name=="une_2eap_f_y"
replace lab = "Male youth unemployment (%)" if wbcode=="YEM" & name=="une_2eap_m_y"
replace lab = "Female labour force participation (%)" if wbcode=="YEM" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="YEM" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="ZAF" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="ZAF" & name=="eap_2wap_m_a"
...
replace lab = "Female labour force participation (%)" if wbcode=="ZMB" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="ZMB" & name=="eap_2wap_m_a"
...
replace lab = "Female primary school completion (%)" if wbcode=="ZWE" & name=="uiscr1f"
replace lab = "Male primary school completion (%)" if wbcode=="ZWE" & name=="uiscr1m"
...
replace lab = "Female labour force participation (%)" if wbcode=="ZWE" & name=="eap_2wap_f_a"
replace lab = "Male labour force participation (%)" if wbcode=="ZWE" & name=="eap_2wap_m_a"
...
/*
	replace lab = "Female labour force participation " if wbcode=="AFG" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="AFG" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="AFG" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="AFG" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="AFG" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="AFG" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="AFG" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="AFG" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="AFG" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="AFG" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="AFG" & name=="unicef_mealfreq"
	replace lab = "Maternal mortality " if wbcode=="AFG" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="AGO" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="AGO" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="AGO" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="AGO" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="AGO" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="AGO" & name=="uiscr2"
	replace lab = "Adolescent fertility " if wbcode=="AGO" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="AGO" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="AGO" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="AGO" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="AGO" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="AGO" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="ALB" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="ALB" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="ALB" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="ALB" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="ALB" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="ALB" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="ALB" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="ALB" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="ALB" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="ALB" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="ALB" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="ALB" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="ARE" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="ARE" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="ARE" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="ARE" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="ARE" & name=="se_lpv_prim"
	replace lab = "Hepatitis B vaccination " if wbcode=="ARE" & name=="vachepbb"
	replace lab = "Adolescent fertility " if wbcode=="ARE" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="ARE" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="ARE" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="ARE" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="ARE" & name=="uisger02"
	replace lab = "BCG vaccination " if wbcode=="ARE" & name=="vacbcg"
	replace lab = "Female labour force participation " if wbcode=="ARG" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="ARG" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="ARG" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="ARG" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="ARG" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="ARG" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="ARG" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="ARG" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="ARG" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="ARG" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="ARG" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="ARG" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="ARM" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="ARM" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="ARM" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="ARM" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="ARM" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="ARM" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="ARM" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="ARM" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="ARM" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="ARM" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="ARM" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="ARM" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="AUS" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="AUS" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="AUS" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="AUS" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="AUS" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="AUS" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="AUS" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="AUS" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="AUS" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="AUS" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="AUS" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="AUS" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="AUT" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="AUT" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="AUT" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="AUT" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="AUT" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="AUT" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="AUT" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="AUT" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="AUT" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="AUT" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="AUT" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="AUT" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="AZE" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="AZE" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="AZE" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="AZE" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="AZE" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="AZE" & name=="se_lpv_prim"
	replace lab = "Adolescent fertility " if wbcode=="AZE" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="AZE" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="AZE" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="AZE" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="AZE" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="AZE" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="BDI" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="BDI" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="BDI" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="BDI" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="BDI" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="BDI" & name=="se_lpv_prim"
	replace lab = "Adolescent fertility " if wbcode=="BDI" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="BDI" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="BDI" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="BDI" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="BDI" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="BDI" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="BEL" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="BEL" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="BEL" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="BEL" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="BEL" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="BEL" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="BEL" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="BEL" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="BEL" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="BEL" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="BEL" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="BEL" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="BEN" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="BEN" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="BEN" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="BEN" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="BEN" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="BEN" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="BEN" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="BEN" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="BEN" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="BEN" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="BEN" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="BEN" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="BFA" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="BFA" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="BFA" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="BFA" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="BFA" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="BFA" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="BFA" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="BFA" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="BFA" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="BFA" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="BFA" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="BFA" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="BGD" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="BGD" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="BGD" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="BGD" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="BGD" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="BGD" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="BGD" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="BGD" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="BGD" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="BGD" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="BGD" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="BGD" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="BGR" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="BGR" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="BGR" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="BGR" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="BGR" & name=="se_lpv_prim"
	replace lab = "Hepatitis B vaccination " if wbcode=="BGR" & name=="vachepbb"
	replace lab = "Adolescent fertility " if wbcode=="BGR" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="BGR" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="BGR" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="BGR" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="BGR" & name=="uisger02"
	replace lab = "BCG vaccination " if wbcode=="BGR" & name=="vacbcg"
	replace lab = "Female labour force participation " if wbcode=="BHR" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="BHR" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="BHR" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="BHR" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="BHR" & name=="se_lpv_prim"
	replace lab = "Hepatitis B vaccination " if wbcode=="BHR" & name=="vachepbb"
	replace lab = "Adolescent fertility " if wbcode=="BHR" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="BHR" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="BHR" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="BHR" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="BHR" & name=="uisger02"
	replace lab = "Completeness of birth registration " if wbcode=="BHR" & name=="lastnm_birth_reg"
	replace lab = "Female labour force participation " if wbcode=="BIH" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="BIH" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="BIH" & name=="sp_dyn_le00_in"
	replace lab = "Lower secondary school completion " if wbcode=="BIH" & name=="uiscr2"
	replace lab = "Female primary school completion " if wbcode=="BIH" & name=="uiscr1f"
	replace lab = "Male primary school completion " if wbcode=="BIH" & name=="uiscr1m"
	replace lab = "Youth NEET " if wbcode=="BIH" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="BIH" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="BIH" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="BIH" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="BIH" & name=="uisger02"
	replace lab = "BCG vaccination " if wbcode=="BIH" & name=="vacbcg"
	replace lab = "Female labour force participation " if wbcode=="BLR" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="BLR" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="BLR" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="BLR" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="BLR" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="BLR" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="BLR" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="BLR" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="BLR" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="BLR" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="BLR" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="BLR" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="BRA" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="BRA" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="BRA" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="BRA" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="BRA" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="BRA" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="BRA" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="BRA" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="BRA" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="BRA" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="BRA" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="BRA" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="BTN" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="BTN" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="BTN" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="BTN" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="BTN" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="BTN" & name=="uiscr2"
	replace lab = "Adolescent fertility " if wbcode=="BTN" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="BTN" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="BTN" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="BTN" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="BTN" & name=="uisger02"
	replace lab = "Infants fed exclusively with breast milk " if wbcode=="BTN" & name=="unicef_breastf"
	replace lab = "Female labour force participation " if wbcode=="BWA" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="BWA" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="BWA" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="BWA" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="BWA" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="BWA" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="BWA" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="BWA" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="BWA" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="BWA" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="BWA" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="BWA" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="CAF" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="CAF" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="CAF" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="CAF" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="CAF" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="CAF" & name=="uiscr2"
	replace lab = "Adolescent fertility " if wbcode=="CAF" & name=="lastnm_afr"
	replace lab = "Female youth unemployment " if wbcode=="CAF" & name=="une_2eap_f_y"
	replace lab = "Male youth unemployment " if wbcode=="CAF" & name=="une_2eap_m_y"
	replace lab = "Neonatal mortality " if wbcode=="CAF" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="CAF" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="CAF" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="CAN" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="CAN" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="CAN" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="CAN" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="CAN" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="CAN" & name=="se_lpv_prim_ma"
	replace lab = "Youth NEET " if wbcode=="CAN" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="CAN" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="CAN" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="CAN" & name=="unicef_neomort"
	replace lab = "Maternal mortality " if wbcode=="CAN" & name=="lastnm_mmrt"
	replace lab = "Completeness of birth registration " if wbcode=="CAN" & name=="lastnm_birth_reg"
	replace lab = "Female labour force participation " if wbcode=="CHL" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="CHL" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="CHL" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="CHL" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="CHL" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="CHL" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="CHL" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="CHL" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="CHL" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="CHL" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="CHL" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="CHL" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="CHN" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="CHN" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="CHN" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="CHN" & name=="uiscr1"
	replace lab = "Learning poverty " if wbcode=="CHN" & name=="se_lpv_prim"
	replace lab = "Lower secondary school completion " if wbcode=="CHN" & name=="uiscr2"
	replace lab = "Adolescent fertility " if wbcode=="CHN" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="CHN" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="CHN" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="CHN" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="CHN" & name=="uisger02"
	replace lab = "Children with diarrhea who attended health facility " if wbcode=="CHN" & name=="unicef_diarrhoea"
	replace lab = "Female labour force participation " if wbcode=="CIV" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="CIV" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="CIV" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="CIV" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="CIV" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="CIV" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="CIV" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="CIV" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="CIV" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="CIV" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="CIV" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="CIV" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="CMR" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="CMR" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="CMR" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="CMR" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="CMR" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="CMR" & name=="se_lpv_prim"
	replace lab = "Adolescent fertility " if wbcode=="CMR" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="CMR" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="CMR" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="CMR" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="CMR" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="CMR" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="COD" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="COD" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="COD" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="COD" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="COD" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="COD" & name=="se_lpv_prim"
	replace lab = "Adolescent fertility " if wbcode=="COD" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="COD" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="COD" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="COD" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="COD" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="COD" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="COG" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="COG" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="COG" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="COG" & name=="uiscr1"
	replace lab = "Learning poverty " if wbcode=="COG" & name=="se_lpv_prim"
	replace lab = "Lower secondary school completion " if wbcode=="COG" & name=="uiscr2"
	replace lab = "Adolescent fertility " if wbcode=="COG" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="COG" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="COG" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="COG" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="COG" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="COG" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="COL" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="COL" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="COL" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="COL" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="COL" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="COL" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="COL" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="COL" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="COL" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="COL" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="COL" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="COL" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="COM" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="COM" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="COM" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="COM" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="COM" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="COM" & name=="uiscr2"
	replace lab = "Adolescent fertility " if wbcode=="COM" & name=="lastnm_afr"
	replace lab = "Female youth unemployment " if wbcode=="COM" & name=="une_2eap_f_y"
	replace lab = "Male youth unemployment " if wbcode=="COM" & name=="une_2eap_m_y"
	replace lab = "Neonatal mortality " if wbcode=="COM" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="COM" & name=="uisger02"
	replace lab = "BCG vaccination " if wbcode=="COM" & name=="vacbcg"
	replace lab = "Female labour force participation " if wbcode=="CRI" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="CRI" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="CRI" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="CRI" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="CRI" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="CRI" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="CRI" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="CRI" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="CRI" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="CRI" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="CRI" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="CRI" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="CUB" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="CUB" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="CUB" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="CUB" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="CUB" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="CUB" & name=="uiscr2"
	replace lab = "Adolescent fertility " if wbcode=="CUB" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="CUB" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="CUB" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="CUB" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="CUB" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="CUB" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="CYP" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="CYP" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="CYP" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="CYP" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="CYP" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="CYP" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="CYP" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="CYP" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="CYP" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="CYP" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="CYP" & name=="uisger02"
	replace lab = "Completeness of birth registration " if wbcode=="CYP" & name=="lastnm_birth_reg"
	replace lab = "Female labour force participation " if wbcode=="CZE" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="CZE" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="CZE" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="CZE" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="CZE" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="CZE" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="CZE" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="CZE" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="CZE" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="CZE" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="CZE" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="CZE" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="DEU" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="DEU" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="DEU" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="DEU" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="DEU" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="DEU" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="DEU" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="DEU" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="DEU" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="DEU" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="DEU" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="DEU" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="DNK" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="DNK" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="DNK" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="DNK" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="DNK" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="DNK" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="DNK" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="DNK" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="DNK" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="DNK" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="DNK" & name=="uisger02"
	replace lab = "Completeness of birth registration " if wbcode=="DNK" & name=="lastnm_birth_reg"
	replace lab = "Female labour force participation " if wbcode=="DOM" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="DOM" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="DOM" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="DOM" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="DOM" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="DOM" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="DOM" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="DOM" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="DOM" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="DOM" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="DOM" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="DOM" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="DZA" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="DZA" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="DZA" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="DZA" & name=="uiscr1"
	replace lab = "Lower secondary school completion " if wbcode=="DZA" & name=="uiscr2"
	replace lab = "Hepatitis B vaccination " if wbcode=="DZA" & name=="vachepbb"
	replace lab = "Adolescent fertility " if wbcode=="DZA" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="DZA" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="DZA" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="DZA" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="DZA" & name=="unicef_mealfreq"
	replace lab = "Postnatal contact with health provider " if wbcode=="DZA" & name=="unicef_care"
	replace lab = "Female labour force participation " if wbcode=="ECU" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="ECU" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="ECU" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="ECU" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="ECU" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="ECU" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="ECU" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="ECU" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="ECU" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="ECU" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="ECU" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="ECU" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="EGY" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="EGY" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="EGY" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="EGY" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="EGY" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="EGY" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="EGY" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="EGY" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="EGY" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="EGY" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="EGY" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="EGY" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="ESP" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="ESP" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="ESP" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="ESP" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="ESP" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="ESP" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="ESP" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="ESP" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="ESP" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="ESP" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="ESP" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="ESP" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="ETH" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="ETH" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="ETH" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="ETH" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="ETH" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="ETH" & name=="se_lpv_prim"
	replace lab = "Adolescent fertility " if wbcode=="ETH" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="ETH" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="ETH" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="ETH" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="ETH" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="ETH" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="FIN" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="FIN" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="FIN" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="FIN" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="FIN" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="FIN" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="FIN" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="FIN" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="FIN" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="FIN" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="FIN" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="FIN" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="FJI" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="FJI" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="FJI" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="FJI" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="FJI" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="FJI" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="FJI" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="FJI" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="FJI" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="FJI" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="FJI" & name=="uisger02"
	replace lab = "Postnatal contact with health provider " if wbcode=="FJI" & name=="unicef_care"
	replace lab = "Female labour force participation " if wbcode=="FRA" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="FRA" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="FRA" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="FRA" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="FRA" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="FRA" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="FRA" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="FRA" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="FRA" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="FRA" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="FRA" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="FRA" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="GAB" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="GAB" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="GAB" & name=="sp_dyn_le00_in"
	replace lab = "Lower secondary school completion " if wbcode=="GAB" & name=="uiscr2"
	replace lab = "Female learning poverty " if wbcode=="GAB" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="GAB" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="GAB" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="GAB" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="GAB" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="GAB" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="GAB" & name=="uisger02"
	replace lab = "BCG vaccination " if wbcode=="GAB" & name=="vacbcg"
	replace lab = "Female labour force participation " if wbcode=="GBR" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="GBR" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="GBR" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="GBR" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="GBR" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="GBR" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="GBR" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="GBR" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="GBR" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="GBR" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="GBR" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="GBR" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="GEO" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="GEO" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="GEO" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="GEO" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="GEO" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="GEO" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="GEO" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="GEO" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="GEO" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="GEO" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="GEO" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="GEO" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="GHA" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="GHA" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="GHA" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="GHA" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="GHA" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="GHA" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="GHA" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="GHA" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="GHA" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="GHA" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="GHA" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="GHA" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="GIN" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="GIN" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="GIN" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="GIN" & name=="uiscr1"
	replace lab = "Learning poverty " if wbcode=="GIN" & name=="se_lpv_prim"
	replace lab = "Lower secondary school completion " if wbcode=="GIN" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="GIN" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="GIN" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="GIN" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="GIN" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="GIN" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="GIN" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="GMB" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="GMB" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="GMB" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="GMB" & name=="uiscr1"
	replace lab = "Lower secondary school completion " if wbcode=="GMB" & name=="uiscr2"
	replace lab = "Hepatitis B vaccination " if wbcode=="GMB" & name=="vachepbb"
	replace lab = "Youth NEET " if wbcode=="GMB" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="GMB" & name=="lastnm_afr"
	replace lab = "Youth unemployment " if wbcode=="GMB" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="GMB" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="GMB" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="GMB" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="GTM" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="GTM" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="GTM" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="GTM" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="GTM" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="GTM" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="GTM" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="GTM" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="GTM" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="GTM" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="GTM" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="GTM" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="GUY" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="GUY" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="GUY" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="GUY" & name=="uiscr1"
	replace lab = "Lower secondary school completion " if wbcode=="GUY" & name=="uiscr2"
	replace lab = "Hepatitis B vaccination " if wbcode=="GUY" & name=="vachepbb"
	replace lab = "Youth NEET " if wbcode=="GUY" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="GUY" & name=="lastnm_afr"
	replace lab = "Youth unemployment " if wbcode=="GUY" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="GUY" & name=="unicef_neomort"
	replace lab = "Postnatal contact with health provider " if wbcode=="GUY" & name=="unicef_care"
	replace lab = "Completeness of birth registration " if wbcode=="GUY" & name=="lastnm_birth_reg"
	replace lab = "Female labour force participation " if wbcode=="HND" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="HND" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="HND" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="HND" & name=="uiscr1"
	replace lab = "Learning poverty " if wbcode=="HND" & name=="se_lpv_prim"
	replace lab = "Lower secondary school completion " if wbcode=="HND" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="HND" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="HND" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="HND" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="HND" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="HND" & name=="uisger02"
	replace lab = "Postnatal contact with health provider " if wbcode=="HND" & name=="unicef_care"
	replace lab = "Female labour force participation " if wbcode=="HRV" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="HRV" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="HRV" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="HRV" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="HRV" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="HRV" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="HRV" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="HRV" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="HRV" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="HRV" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="HRV" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="HRV" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="HTI" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="HTI" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="HTI" & name=="sp_dyn_le00_in"
	replace lab = "Lower secondary school completion " if wbcode=="HTI" & name=="uiscr2"
	replace lab = "Female primary school completion " if wbcode=="HTI" & name=="uiscr1f"
	replace lab = "Male primary school completion " if wbcode=="HTI" & name=="uiscr1m"
	replace lab = "Adolescent fertility " if wbcode=="HTI" & name=="lastnm_afr"
	replace lab = "Female youth unemployment " if wbcode=="HTI" & name=="une_2eap_f_y"
	replace lab = "Male youth unemployment " if wbcode=="HTI" & name=="une_2eap_m_y"
	replace lab = "Neonatal mortality " if wbcode=="HTI" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="HTI" & name=="unicef_mealfreq"
	replace lab = "Maternal mortality " if wbcode=="HTI" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="HUN" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="HUN" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="HUN" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="HUN" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="HUN" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="HUN" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="HUN" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="HUN" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="HUN" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="HUN" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="HUN" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="HUN" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="IDN" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="IDN" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="IDN" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="IDN" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="IDN" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="IDN" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="IDN" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="IDN" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="IDN" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="IDN" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="IDN" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="IDN" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="IND" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="IND" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="IND" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="IND" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="IND" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="IND" & name=="se_lpv_prim"
	replace lab = "Adolescent fertility " if wbcode=="IND" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="IND" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="IND" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="IND" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="IND" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="IND" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="IRL" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="IRL" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="IRL" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="IRL" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="IRL" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="IRL" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="IRL" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="IRL" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="IRL" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="IRL" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="IRL" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="IRL" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="IRN" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="IRN" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="IRN" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="IRN" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="IRN" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="IRN" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="IRN" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="IRN" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="IRN" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="IRN" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="IRN" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="IRN" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="IRQ" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="IRQ" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="IRQ" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="IRQ" & name=="uiscr1"
	replace lab = "Lower secondary school completion " if wbcode=="IRQ" & name=="uiscr2"
	replace lab = "Hepatitis B vaccination " if wbcode=="IRQ" & name=="vachepbb"
	replace lab = "Adolescent fertility " if wbcode=="IRQ" & name=="lastnm_afr"
	replace lab = "Female youth unemployment " if wbcode=="IRQ" & name=="une_2eap_f_y"
	replace lab = "Male youth unemployment " if wbcode=="IRQ" & name=="une_2eap_m_y"
	replace lab = "Neonatal mortality " if wbcode=="IRQ" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="IRQ" & name=="unicef_mealfreq"
	replace lab = "Postnatal contact with health provider " if wbcode=="IRQ" & name=="unicef_care"
	replace lab = "Female labour force participation " if wbcode=="ISR" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="ISR" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="ISR" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="ISR" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="ISR" & name=="se_lpv_prim"
	replace lab = "Hepatitis B vaccination " if wbcode=="ISR" & name=="vachepbb"
	replace lab = "Adolescent fertility " if wbcode=="ISR" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="ISR" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="ISR" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="ISR" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="ISR" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="ISR" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="ITA" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="ITA" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="ITA" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="ITA" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="ITA" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="ITA" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="ITA" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="ITA" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="ITA" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="ITA" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="ITA" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="ITA" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="JAM" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="JAM" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="JAM" & name=="sp_dyn_le00_in"
	replace lab = "Lower secondary school completion " if wbcode=="JAM" & name=="uiscr2"
	replace lab = "Female primary school completion " if wbcode=="JAM" & name=="uiscr1f"
	replace lab = "Male primary school completion " if wbcode=="JAM" & name=="uiscr1m"
	replace lab = "Youth NEET " if wbcode=="JAM" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="JAM" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="JAM" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="JAM" & name=="unicef_neomort"
	replace lab = "Completeness of birth registration " if wbcode=="JAM" & name=="lastnm_birth_reg"
	replace lab = "BCG vaccination " if wbcode=="JAM" & name=="vacbcg"
	replace lab = "Female labour force participation " if wbcode=="JOR" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="JOR" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="JOR" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="JOR" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="JOR" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="JOR" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="JOR" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="JOR" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="JOR" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="JOR" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="JOR" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="JOR" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="KAZ" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="KAZ" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="KAZ" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="KAZ" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="KAZ" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="KAZ" & name=="se_lpv_prim"
	replace lab = "Adolescent fertility " if wbcode=="KAZ" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="KAZ" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="KAZ" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="KAZ" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="KAZ" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="KAZ" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="KEN" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="KEN" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="KEN" & name=="sp_dyn_le00_in"
	replace lab = "Lower secondary school completion " if wbcode=="KEN" & name=="uiscr2"
	replace lab = "Female primary school completion " if wbcode=="KEN" & name=="uiscr1f"
	replace lab = "Male primary school completion " if wbcode=="KEN" & name=="uiscr1m"
	replace lab = "Youth NEET " if wbcode=="KEN" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="KEN" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="KEN" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="KEN" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="KEN" & name=="uisger02"
	replace lab = "BCG vaccination " if wbcode=="KEN" & name=="vacbcg"
	replace lab = "Female labour force participation " if wbcode=="KGZ" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="KGZ" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="KGZ" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="KGZ" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="KGZ" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="KGZ" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="KGZ" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="KGZ" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="KGZ" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="KGZ" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="KGZ" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="KGZ" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="KHM" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="KHM" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="KHM" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="KHM" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="KHM" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="KHM" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="KHM" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="KHM" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="KHM" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="KHM" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="KHM" & name=="uisger02"
	replace lab = "BCG vaccination " if wbcode=="KHM" & name=="vacbcg"
	replace lab = "Probability of dying from NCDs " if wbcode=="KIR" & name=="lastnm_probdeath_ncd"
	replace lab = "Female life expectancy at birth " if wbcode=="KIR" & name=="sp_dyn_le00_fe_in"
	replace lab = "Male life expectancy at birth " if wbcode=="KIR" & name=="sp_dyn_le00_ma_in"
	replace lab = "Primary school completion " if wbcode=="KIR" & name=="uiscr1"
	replace lab = "Lower secondary school completion " if wbcode=="KIR" & name=="uiscr2"
	replace lab = "Hepatitis B vaccination " if wbcode=="KIR" & name=="vachepbb"
	replace lab = "Adolescent fertility " if wbcode=="KIR" & name=="lastnm_afr"
	replace lab = "Female youth NEET " if wbcode=="KIR" & name=="eip_neet_f_y"
	replace lab = "Male youth NEET " if wbcode=="KIR" & name=="eip_neet_m_y"
	replace lab = "Neonatal mortality " if wbcode=="KIR" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="KIR" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="KIR" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="KOR" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="KOR" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="KOR" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="KOR" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="KOR" & name=="se_lpv_prim"
	replace lab = "Hepatitis B vaccination " if wbcode=="KOR" & name=="vachepbb"
	replace lab = "Adolescent fertility " if wbcode=="KOR" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="KOR" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="KOR" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="KOR" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="KOR" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="KOR" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="KWT" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="KWT" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="KWT" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="KWT" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="KWT" & name=="se_lpv_prim"
	replace lab = "Hepatitis B vaccination " if wbcode=="KWT" & name=="vachepbb"
	replace lab = "Adolescent fertility " if wbcode=="KWT" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="KWT" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="KWT" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="KWT" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="KWT" & name=="uisger02"
	replace lab = "BCG vaccination " if wbcode=="KWT" & name=="vacbcg"
	replace lab = "Female labour force participation " if wbcode=="LAO" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="LAO" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="LAO" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="LAO" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="LAO" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="LAO" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="LAO" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="LAO" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="LAO" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="LAO" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="LAO" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="LAO" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="LBR" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="LBR" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="LBR" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="LBR" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="LBR" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="LBR" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="LBR" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="LBR" & name=="lastnm_afr"
	replace lab = "Youth unemployment " if wbcode=="LBR" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="LBR" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="LBR" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="LBR" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="LSO" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="LSO" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="LSO" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="LSO" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="LSO" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="LSO" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="LSO" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="LSO" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="LSO" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="LSO" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="LSO" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="LSO" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="LTU" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="LTU" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="LTU" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="LTU" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="LTU" & name=="se_lpv_prim"
	replace lab = "Hepatitis B vaccination " if wbcode=="LTU" & name=="vachepbb"
	replace lab = "Adolescent fertility " if wbcode=="LTU" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="LTU" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="LTU" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="LTU" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="LTU" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="LTU" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="LVA" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="LVA" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="LVA" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="LVA" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="LVA" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="LVA" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="LVA" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="LVA" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="LVA" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="LVA" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="LVA" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="LVA" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="MAR" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="MAR" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="MAR" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="MAR" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="MAR" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="MAR" & name=="se_lpv_prim"
	replace lab = "Adolescent fertility " if wbcode=="MAR" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="MAR" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="MAR" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="MAR" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="MAR" & name=="uisger02"
	replace lab = "Completeness of birth registration " if wbcode=="MAR" & name=="lastnm_birth_reg"
	replace lab = "Female labour force participation " if wbcode=="MDA" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="MDA" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="MDA" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="MDA" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="MDA" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="MDA" & name=="uiscr2"
	replace lab = "Adolescent fertility " if wbcode=="MDA" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="MDA" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="MDA" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="MDA" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="MDA" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="MDA" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="MDG" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="MDG" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="MDG" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="MDG" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="MDG" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="MDG" & name=="se_lpv_prim"
	replace lab = "Adolescent fertility " if wbcode=="MDG" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="MDG" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="MDG" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="MDG" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="MDG" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="MDG" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="MEX" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="MEX" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="MEX" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="MEX" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="MEX" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="MEX" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="MEX" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="MEX" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="MEX" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="MEX" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="MEX" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="MEX" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="MKD" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="MKD" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="MKD" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="MKD" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="MKD" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="MKD" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="MKD" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="MKD" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="MKD" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="MKD" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="MKD" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="MKD" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="MLI" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="MLI" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="MLI" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="MLI" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="MLI" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="MLI" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="MLI" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="MLI" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="MLI" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="MLI" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="MLI" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="MLI" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="MMR" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="MMR" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="MMR" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="MMR" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="MMR" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="MMR" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="MMR" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="MMR" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="MMR" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="MMR" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="MMR" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="MMR" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="MNE" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="MNE" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="MNE" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="MNE" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="MNE" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="MNE" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="MNE" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="MNE" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="MNE" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="MNE" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="MNE" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="MNE" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="MNG" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="MNG" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="MNG" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="MNG" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="MNG" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="MNG" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="MNG" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="MNG" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="MNG" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="MNG" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="MNG" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="MNG" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="MOZ" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="MOZ" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="MOZ" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="MOZ" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="MOZ" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="MOZ" & name=="uiscr2"
	replace lab = "Adolescent fertility " if wbcode=="MOZ" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="MOZ" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="MOZ" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="MOZ" & name=="unicef_neomort"
	replace lab = "Postnatal contact with health provider " if wbcode=="MOZ" & name=="unicef_care"
	replace lab = "Completeness of birth registration " if wbcode=="MOZ" & name=="lastnm_birth_reg"
	replace lab = "Female labour force participation " if wbcode=="MRT" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="MRT" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="MRT" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="MRT" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="MRT" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="MRT" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="MRT" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="MRT" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="MRT" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="MRT" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="MRT" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="MRT" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="MUS" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="MUS" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="MUS" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="MUS" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="MUS" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="MUS" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="MUS" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="MUS" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="MUS" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="MUS" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="MUS" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="MUS" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="MWI" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="MWI" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="MWI" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="MWI" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="MWI" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="MWI" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="MWI" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="MWI" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="MWI" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="MWI" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="MWI" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="MWI" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="MYS" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="MYS" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="MYS" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="MYS" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="MYS" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="MYS" & name=="se_lpv_prim"
	replace lab = "Adolescent fertility " if wbcode=="MYS" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="MYS" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="MYS" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="MYS" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="MYS" & name=="uisger02"
	replace lab = "Infants fed exclusively with breast milk " if wbcode=="MYS" & name=="unicef_breastf"
	replace lab = "Female labour force participation " if wbcode=="NAM" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="NAM" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="NAM" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="NAM" & name=="uiscr1"
	replace lab = "Lower secondary school completion " if wbcode=="NAM" & name=="uiscr2"
	replace lab = "Hepatitis B vaccination " if wbcode=="NAM" & name=="vachepbb"
	replace lab = "Youth NEET " if wbcode=="NAM" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="NAM" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="NAM" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="NAM" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="NAM" & name=="uisger02"
	replace lab = "Completeness of birth registration " if wbcode=="NAM" & name=="lastnm_birth_reg"
	replace lab = "Female labour force participation " if wbcode=="NER" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="NER" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="NER" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="NER" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="NER" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="NER" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="NER" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="NER" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="NER" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="NER" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="NER" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="NER" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="NGA" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="NGA" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="NGA" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="NGA" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="NGA" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="NGA" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="NGA" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="NGA" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="NGA" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="NGA" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="NGA" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="NGA" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="NIC" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="NIC" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="NIC" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="NIC" & name=="uiscr1"
	replace lab = "Learning poverty " if wbcode=="NIC" & name=="se_lpv_prim"
	replace lab = "Lower secondary school completion " if wbcode=="NIC" & name=="uiscr2"
	replace lab = "Adolescent fertility " if wbcode=="NIC" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="NIC" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="NIC" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="NIC" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="NIC" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="NIC" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="NLD" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="NLD" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="NLD" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="NLD" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="NLD" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="NLD" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="NLD" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="NLD" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="NLD" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="NLD" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="NLD" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="NLD" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="NOR" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="NOR" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="NOR" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="NOR" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="NOR" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="NOR" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="NOR" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="NOR" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="NOR" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="NOR" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="NOR" & name=="uisger02"
	replace lab = "Completeness of birth registration " if wbcode=="NOR" & name=="lastnm_birth_reg"
	replace lab = "Female labour force participation " if wbcode=="NPL" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="NPL" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="NPL" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="NPL" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="NPL" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="NPL" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="NPL" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="NPL" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="NPL" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="NPL" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="NPL" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="NPL" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="NZL" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="NZL" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="NZL" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="NZL" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="NZL" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="NZL" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="NZL" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="NZL" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="NZL" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="NZL" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="NZL" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="NZL" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="OMN" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="OMN" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="OMN" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="OMN" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="OMN" & name=="se_lpv_prim"
	replace lab = "Hepatitis B vaccination " if wbcode=="OMN" & name=="vachepbb"
	replace lab = "Adolescent fertility " if wbcode=="OMN" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="OMN" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="OMN" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="OMN" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="OMN" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="OMN" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="PAK" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="PAK" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="PAK" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="PAK" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="PAK" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="PAK" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="PAK" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="PAK" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="PAK" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="PAK" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="PAK" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="PAK" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="PAN" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="PAN" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="PAN" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="PAN" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="PAN" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="PAN" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="PAN" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="PAN" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="PAN" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="PAN" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="PAN" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="PAN" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="PER" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="PER" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="PER" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="PER" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="PER" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="PER" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="PER" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="PER" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="PER" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="PER" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="PER" & name=="uisger02"
	replace lab = "Completeness of birth registration " if wbcode=="PER" & name=="lastnm_birth_reg"
	replace lab = "Female labour force participation " if wbcode=="PHL" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="PHL" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="PHL" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="PHL" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="PHL" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="PHL" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="PHL" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="PHL" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="PHL" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="PHL" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="PHL" & name=="uisger02"
	replace lab = "Postnatal contact with health provider " if wbcode=="PHL" & name=="unicef_care"
	replace lab = "Female labour force participation " if wbcode=="PNG" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="PNG" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="PNG" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="PNG" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="PNG" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="PNG" & name=="uiscr2"
	replace lab = "Adolescent fertility " if wbcode=="PNG" & name=="lastnm_afr"
	replace lab = "Female youth unemployment " if wbcode=="PNG" & name=="une_2eap_f_y"
	replace lab = "Male youth unemployment " if wbcode=="PNG" & name=="une_2eap_m_y"
	replace lab = "Neonatal mortality " if wbcode=="PNG" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="PNG" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="PNG" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="POL" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="POL" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="POL" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="POL" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="POL" & name=="se_lpv_prim"
	replace lab = "Hepatitis B vaccination " if wbcode=="POL" & name=="vachepbb"
	replace lab = "Adolescent fertility " if wbcode=="POL" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="POL" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="POL" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="POL" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="POL" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="POL" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="PRT" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="PRT" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="PRT" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="PRT" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="PRT" & name=="se_lpv_prim"
	replace lab = "Hepatitis B vaccination " if wbcode=="PRT" & name=="vachepbb"
	replace lab = "Youth NEET " if wbcode=="PRT" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="PRT" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="PRT" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="PRT" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="PRT" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="PRT" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="PRY" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="PRY" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="PRY" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="PRY" & name=="uiscr1"
	replace lab = "Learning poverty " if wbcode=="PRY" & name=="se_lpv_prim"
	replace lab = "Lower secondary school completion " if wbcode=="PRY" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="PRY" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="PRY" & name=="lastnm_afr"
	replace lab = "Youth unemployment " if wbcode=="PRY" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="PRY" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="PRY" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="PRY" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="PSE" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="PSE" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="PSE" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="PSE" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="PSE" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="PSE" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="PSE" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="PSE" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="PSE" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="PSE" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="PSE" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="PSE" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="QAT" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="QAT" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="QAT" & name=="sp_dyn_le00_in"
	replace lab = "Hepatitis B vaccination " if wbcode=="QAT" & name=="vachepbb"
	replace lab = "Female learning poverty " if wbcode=="QAT" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="QAT" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="QAT" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="QAT" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="QAT" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="QAT" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="QAT" & name=="uisger02"
	replace lab = "Completeness of birth registration " if wbcode=="QAT" & name=="lastnm_birth_reg"
	replace lab = "Female labour force participation " if wbcode=="RUS" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="RUS" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="RUS" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="RUS" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="RUS" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="RUS" & name=="se_lpv_prim"
	replace lab = "Adolescent fertility " if wbcode=="RUS" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="RUS" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="RUS" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="RUS" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="RUS" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="RUS" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="RWA" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="RWA" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="RWA" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="RWA" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="RWA" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="RWA" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="RWA" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="RWA" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="RWA" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="RWA" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="RWA" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="RWA" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="SAU" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="SAU" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="SAU" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="SAU" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="SAU" & name=="se_lpv_prim"
	replace lab = "Hepatitis B vaccination " if wbcode=="SAU" & name=="vachepbb"
	replace lab = "Adolescent fertility " if wbcode=="SAU" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="SAU" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="SAU" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="SAU" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="SAU" & name=="uisger02"
	replace lab = "Completeness of birth registration " if wbcode=="SAU" & name=="lastnm_birth_reg"
	replace lab = "Female labour force participation " if wbcode=="SDN" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="SDN" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="SDN" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="SDN" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="SDN" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="SDN" & name=="uiscr2"
	replace lab = "Adolescent fertility " if wbcode=="SDN" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="SDN" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="SDN" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="SDN" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="SDN" & name=="uisger02"
	replace lab = "BCG vaccination " if wbcode=="SDN" & name=="vacbcg"
	replace lab = "Female labour force participation " if wbcode=="SEN" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="SEN" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="SEN" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="SEN" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="SEN" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="SEN" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="SEN" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="SEN" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="SEN" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="SEN" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="SEN" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="SEN" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="SGP" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="SGP" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="SGP" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="SGP" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="SGP" & name=="se_lpv_prim"
	replace lab = "Hepatitis B vaccination " if wbcode=="SGP" & name=="vachepbb"
	replace lab = "Adolescent fertility " if wbcode=="SGP" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="SGP" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="SGP" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="SGP" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="SGP" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="SGP" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="SLE" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="SLE" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="SLE" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="SLE" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="SLE" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="SLE" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="SLE" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="SLE" & name=="lastnm_afr"
	replace lab = "Youth unemployment " if wbcode=="SLE" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="SLE" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="SLE" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="SLE" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="SLV" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="SLV" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="SLV" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="SLV" & name=="uiscr1"
	replace lab = "Lower secondary school completion " if wbcode=="SLV" & name=="uiscr2"
	replace lab = "Hepatitis B vaccination " if wbcode=="SLV" & name=="vachepbb"
	replace lab = "Youth NEET " if wbcode=="SLV" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="SLV" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="SLV" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="SLV" & name=="unicef_neomort"
	replace lab = "Completeness of birth registration " if wbcode=="SLV" & name=="lastnm_birth_reg"
	replace lab = "BCG vaccination " if wbcode=="SLV" & name=="vacbcg"
	replace lab = "Female labour force participation " if wbcode=="SRB" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="SRB" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="SRB" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="SRB" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="SRB" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="SRB" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="SRB" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="SRB" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="SRB" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="SRB" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="SRB" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="SRB" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="SSD" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="SSD" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="SSD" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="SSD" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="SSD" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="SSD" & name=="uiscr2"
	replace lab = "Adolescent fertility " if wbcode=="SSD" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="SSD" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="SSD" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="SSD" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="SSD" & name=="uisger02"
	replace lab = "BCG vaccination " if wbcode=="SSD" & name=="vacbcg"
	replace lab = "Female labour force participation " if wbcode=="SVK" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="SVK" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="SVK" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="SVK" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="SVK" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="SVK" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="SVK" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="SVK" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="SVK" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="SVK" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="SVK" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="SVK" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="SVN" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="SVN" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="SVN" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="SVN" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="SVN" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="SVN" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="SVN" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="SVN" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="SVN" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="SVN" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="SVN" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="SVN" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="SWE" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="SWE" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="SWE" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="SWE" & name=="lastnm_sec_ger"
	replace lab = "Female learning poverty " if wbcode=="SWE" & name=="se_lpv_prim_fe"
	replace lab = "Male learning poverty " if wbcode=="SWE" & name=="se_lpv_prim_ma"
	replace lab = "Adolescent fertility " if wbcode=="SWE" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="SWE" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="SWE" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="SWE" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="SWE" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="SWE" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="SYR" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="SYR" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="SYR" & name=="sp_dyn_le00_in"
	replace lab = "Lower secondary school completion " if wbcode=="SYR" & name=="uiscr2"
	replace lab = "Female primary school completion " if wbcode=="SYR" & name=="uiscr1f"
	replace lab = "Male primary school completion " if wbcode=="SYR" & name=="uiscr1m"
	replace lab = "Adolescent fertility " if wbcode=="SYR" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="SYR" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="SYR" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="SYR" & name=="unicef_neomort"
	replace lab = "Infants fed exclusively with breast milk " if wbcode=="SYR" & name=="unicef_breastf"
	replace lab = "BCG vaccination " if wbcode=="SYR" & name=="vacbcg"
	replace lab = "Female labour force participation " if wbcode=="TCD" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="TCD" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="TCD" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="TCD" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="TCD" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="TCD" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="TCD" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="TCD" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="TCD" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="TCD" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="TCD" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="TCD" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="TGO" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="TGO" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="TGO" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="TGO" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="TGO" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="TGO" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="TGO" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="TGO" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="TGO" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="TGO" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="TGO" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="TGO" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="THA" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="THA" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="THA" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="THA" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="THA" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="THA" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="THA" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="THA" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="THA" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="THA" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="THA" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="THA" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="TJK" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="TJK" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="TJK" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="TJK" & name=="uiscr1"
	replace lab = "Lower secondary school completion " if wbcode=="TJK" & name=="uiscr2"
	replace lab = "Hepatitis B vaccination " if wbcode=="TJK" & name=="vachepbb"
	replace lab = "Adolescent fertility " if wbcode=="TJK" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="TJK" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="TJK" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="TJK" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="TJK" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="TJK" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="TLS" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="TLS" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="TLS" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="TLS" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="TLS" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="TLS" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="TLS" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="TLS" & name=="lastnm_afr"
	replace lab = "Youth unemployment " if wbcode=="TLS" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="TLS" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="TLS" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="TLS" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="TON" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="TON" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="TON" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="TON" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="TON" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="TON" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="TON" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="TON" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="TON" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="TON" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="TON" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="TON" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="TTO" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="TTO" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="TTO" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="TTO" & name=="uiscr1"
	replace lab = "Learning poverty " if wbcode=="TTO" & name=="se_lpv_prim"
	replace lab = "Lower secondary school completion " if wbcode=="TTO" & name=="uiscr2"
	replace lab = "Adolescent fertility " if wbcode=="TTO" & name=="lastnm_afr"
	replace lab = "Female youth unemployment " if wbcode=="TTO" & name=="une_2eap_f_y"
	replace lab = "Male youth unemployment " if wbcode=="TTO" & name=="une_2eap_m_y"
	replace lab = "Neonatal mortality " if wbcode=="TTO" & name=="unicef_neomort"
	replace lab = "Female Pre-primary school gross enrollment " if wbcode=="TTO" & name=="uisger02f"
	replace lab = "Male Pre-primary school gross enrollment " if wbcode=="TTO" & name=="uisger02m"
	replace lab = "Female labour force participation " if wbcode=="TUN" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="TUN" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="TUN" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="TUN" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="TUN" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="TUN" & name=="uiscr2"
	replace lab = "Adolescent fertility " if wbcode=="TUN" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="TUN" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="TUN" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="TUN" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="TUN" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="TUN" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="TUR" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="TUR" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="TUR" & name=="sp_dyn_le00_in"
	replace lab = "Gross secondary school enrollment " if wbcode=="TUR" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="TUR" & name=="se_lpv_prim"
	replace lab = "Hepatitis B vaccination " if wbcode=="TUR" & name=="vachepbb"
	replace lab = "Youth NEET " if wbcode=="TUR" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="TUR" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="TUR" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="TUR" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="TUR" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="TUR" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="TZA" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="TZA" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="TZA" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="TZA" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="TZA" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="TZA" & name=="uiscr2"
	replace lab = "Adolescent fertility " if wbcode=="TZA" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="TZA" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="TZA" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="TZA" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="TZA" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="TZA" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="UGA" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="UGA" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="UGA" & name=="sp_dyn_le00_in"
	replace lab = "Lower secondary school completion " if wbcode=="UGA" & name=="uiscr2"
	replace lab = "Female primary school completion " if wbcode=="UGA" & name=="uiscr1f"
	replace lab = "Male primary school completion " if wbcode=="UGA" & name=="uiscr1m"
	replace lab = "Youth NEET " if wbcode=="UGA" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="UGA" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="UGA" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="UGA" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="UGA" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="UGA" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="UKR" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="UKR" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="UKR" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="UKR" & name=="uiscr1"
	replace lab = "Lower secondary school completion " if wbcode=="UKR" & name=="uiscr2"
	replace lab = "Hepatitis B vaccination " if wbcode=="UKR" & name=="vachepbb"
	replace lab = "Adolescent fertility " if wbcode=="UKR" & name=="lastnm_afr"
	replace lab = "Female youth unemployment " if wbcode=="UKR" & name=="une_2eap_f_y"
	replace lab = "Male youth unemployment " if wbcode=="UKR" & name=="une_2eap_m_y"
	replace lab = "Neonatal mortality " if wbcode=="UKR" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="UKR" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="UKR" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="URY" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="URY" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="URY" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="URY" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="URY" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="URY" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="URY" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="URY" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="URY" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="URY" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="URY" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="URY" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="USA" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="USA" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="USA" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="USA" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="USA" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="USA" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="USA" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="USA" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="USA" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="USA" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="USA" & name=="uisger02"
	replace lab = "Maternal mortality " if wbcode=="USA" & name=="lastnm_mmrt"
	replace lab = "Female labour force participation " if wbcode=="UZB" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="UZB" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="UZB" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="UZB" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="UZB" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="UZB" & name=="uiscr2"
	replace lab = "Adolescent fertility " if wbcode=="UZB" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="UZB" & name=="lastnm_ter_ger"
	replace lab = "Youth unemployment " if wbcode=="UZB" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="UZB" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="UZB" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="UZB" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="VNM" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="VNM" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="VNM" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="VNM" & name=="uiscr1"
	replace lab = "Learning poverty " if wbcode=="VNM" & name=="se_lpv_prim"
	replace lab = "Lower secondary school completion " if wbcode=="VNM" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="VNM" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="VNM" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="VNM" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="VNM" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="VNM" & name=="uisger02"
	replace lab = "Postnatal contact with health provider " if wbcode=="VNM" & name=="unicef_care"
	replace lab = "Female labour force participation " if wbcode=="VUT" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="VUT" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="VUT" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="VUT" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="VUT" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="VUT" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="VUT" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="VUT" & name=="lastnm_afr"
	replace lab = "Youth unemployment " if wbcode=="VUT" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="VUT" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="VUT" & name=="uisger02"
	replace lab = "BCG vaccination " if wbcode=="VUT" & name=="vacbcg"
	replace lab = "Female labour force participation " if wbcode=="WSM" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="WSM" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="WSM" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="WSM" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="WSM" & name=="lastnm_sec_ger"
	replace lab = "Lower secondary school completion " if wbcode=="WSM" & name=="uiscr2"
	replace lab = "Youth NEET " if wbcode=="WSM" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="WSM" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="WSM" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="WSM" & name=="unicef_neomort"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="WSM" & name=="uisger02"
	replace lab = "Postnatal contact with health provider " if wbcode=="WSM" & name=="unicef_care"
	replace lab = "Female labour force participation " if wbcode=="ZAF" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="ZAF" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="ZAF" & name=="sp_dyn_le00_in"
	replace lab = "Primary school completion " if wbcode=="ZAF" & name=="uiscr1"
	replace lab = "Gross secondary school enrollment " if wbcode=="ZAF" & name=="lastnm_sec_ger"
	replace lab = "Learning poverty " if wbcode=="ZAF" & name=="se_lpv_prim"
	replace lab = "Youth NEET " if wbcode=="ZAF" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="ZAF" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="ZAF" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="ZAF" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="ZAF" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="ZAF" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="ZMB" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="ZMB" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="ZMB" & name=="sp_dyn_le00_in"
	replace lab = "Lower secondary school completion " if wbcode=="ZMB" & name=="uiscr2"
	replace lab = "Female primary school completion " if wbcode=="ZMB" & name=="uiscr1f"
	replace lab = "Male primary school completion " if wbcode=="ZMB" & name=="uiscr1m"
	replace lab = "Youth NEET " if wbcode=="ZMB" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="ZMB" & name=="lastnm_afr"
	replace lab = "Youth unemployment " if wbcode=="ZMB" & name=="une_2eap_mf_y"
	replace lab = "Neonatal mortality " if wbcode=="ZMB" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="ZMB" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="ZMB" & name=="uisger02"
	replace lab = "Female labour force participation " if wbcode=="ZWE" & name=="eap_2wap_f_a"
	replace lab = "Male labour force participation " if wbcode=="ZWE" & name=="eap_2wap_m_a"
	replace lab = "Life expectancy at birth " if wbcode=="ZWE" & name=="sp_dyn_le00_in"
	replace lab = "Lower secondary school completion " if wbcode=="ZWE" & name=="uiscr2"
	replace lab = "Female primary school completion " if wbcode=="ZWE" & name=="uiscr1f"
	replace lab = "Male primary school completion " if wbcode=="ZWE" & name=="uiscr1m"
	replace lab = "Youth NEET " if wbcode=="ZWE" & name=="eip_neet_mf_y"
	replace lab = "Adolescent fertility " if wbcode=="ZWE" & name=="lastnm_afr"
	replace lab = "Gross tertiary education enrollment " if wbcode=="ZWE" & name=="lastnm_ter_ger"
	replace lab = "Neonatal mortality " if wbcode=="ZWE" & name=="unicef_neomort"
	replace lab = "Children receiving minimum meal frequency " if wbcode=="ZWE" & name=="unicef_mealfreq"
	replace lab = "Pre-primary school gross enrollment " if wbcode=="ZWE" & name=="uisger02"
	*/
}	
	...
	aorder 
	order wbcode
	export excel "$input\ordered_2", replace firstrow(variable) 
	save "$input\ordered_text", replace

	*--------------------------Merge to original base--------------------------*
	
	/**** Acá nos pidieron agregar algunos indicadres, a parte de los name, lab y text para cada stage y orden ****/
	
	use "$input\text", clear
	drop unicef_neomort_text unicef_mealfreq_text vacbcg_text uisger02_text uisger02f_text uisger02m_text uisger01_text lastnm_mmrt_text_1 unicef_care_text lastnm_birth_reg_text_1 unicef_breastf_text unicef_diarrhoea_text uiscr1_text uiscr1f_text uiscr1m_text lastnm_sec_ger_text_1 se_lpv_prim_text se_lpv_prim_fe_text se_lpv_prim_ma_text vachepbb_text uiscr2_text eip_neet_mf_y_text eip_neet_f_y_text eip_neet_m_y_text lastnm_afr_text_1 lastnm_ter_ger_text une_2eap_mf_y_text une_2eap_f_y_text une_2eap_m_y_text eap_2wap_f_a_text eap_2wap_m_a_text sp_dyn_le00_in_text sp_dyn_le00_fe_in_text sp_dyn_le00_ma_in_text lastnm_probdeath_ncd_text_1
	merge 1:1 wbcode using "$input\ordered_text", nogen 	
	export excel "$input\ordered_2", replace firstrow(variable) 
	save "$input\ordered_text", replace
		
	preserve
	use "$input\ordered_text", clear
	keep wbcode text_early* text_school* text_youth* text_adults*
	order wbcode text_early* text_school* text_youth* text_adults*
	export excel "$input\ordered_text.csv", replace firstrow(variable) 
	restore 
