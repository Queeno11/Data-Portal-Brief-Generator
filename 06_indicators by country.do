...
global charts           "${root}\Outputs\Update"    // FIXME: check if i like this
...
*--------------------------------Metadata----------------------------------*	
	...
	*ESTO YA ESTÁ DIRECTAMENTE EN EL EXCEL. CHEQUEAR QUE COINCIDAN CON LAS DE ACÁ UNA POR UNA:
*-----------------------------Stages of life-------------------------------*	
...
// 	replace rank = 5 if name=="une_2eap_mf_a"
	...
	bysort wbcode category topic: gen arank = _n
